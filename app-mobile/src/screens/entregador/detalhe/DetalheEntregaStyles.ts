...
export const detalheEntregaStyles = StyleSheet.create({
  ...
  avisoRastreamentoTitulo: {
    color: "#1d4ed8",
    fontSize: 14,
    fontWeight: "700",
  },
  avisoRastreamentoTexto: {
    color: "#374151",
    fontSize: 12,
    lineHeight: 18,
    marginTop: 4,
  ...
  statusRastreamentoLimitado: {
    backgroundColor: "#fffbeb",
    borderColor: "#fde68a",
  },
  statusRastreamentoTitulo: {
    color: "#047857",
    fontSize: 14,
    fontWeight: "700",
  },
  statusRastreamentoTituloLimitado: { color: "#b45309" },
  statusRastreamentoTexto: {
    color: "#374151",
    fontSize: 12,
    lineHeight: 18,
    marginTop: 4,
