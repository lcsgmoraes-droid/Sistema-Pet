...
export const funcionarioPdvStyles = StyleSheet.create({
  ...
  botaoDescontoTotalConteudo: { flex: 1 },
  botaoDescontoTotalTexto: {
    color: CORES.primario,
    fontSize: FONTE.normal,
    fontWeight: "900",
  },
  botaoDescontoTotalAjuda: {
  ...
  itemDesconto: { color: CORES.sucesso, fontSize: FONTE.pequena, fontWeight: "800" },
  itemEditarAjuda: { color: CORES.primario, fontSize: 11, fontWeight: "700" },
  clienteSelecionado: {
    flexDirection: "row",
    alignItems: "center",
    borderWidth: 1,
  ...
  crediarioIntervaloBotaoAtivo: {
    borderColor: CORES.primario,
    backgroundColor: CORES.primarioClaro,
  },
  crediarioIntervaloTexto: { color: CORES.textoSecundario, fontWeight: "800" },
  crediarioIntervaloTextoAtivo: { color: CORES.primario },
  crediarioPrevia: {
    marginTop: ESPACO.md,
    padding: ESPACO.sm,
    gap: 5,
  ...
  crediarioPreviaTitulo: { color: "#78350F", fontWeight: "900", marginBottom: 2 },
  crediarioPreviaLinha: { flexDirection: "row", justifyContent: "space-between", gap: ESPACO.sm },
  crediarioPreviaTexto: { flex: 1, color: "#92400E", fontSize: FONTE.pequena },
  crediarioPreviaValor: { color: "#78350F", fontSize: FONTE.pequena, fontWeight: "900" },
  crediarioPreviaRodape: { color: "#92400E", fontSize: 11, marginTop: 3 },
  resumo: {
    backgroundColor: CORES.superficie,
    borderRadius: RAIO.md,
    padding: ESPACO.md,
