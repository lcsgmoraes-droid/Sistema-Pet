...
ANDROID_MANIFEST = ROOT / "app-mobile" / "android" / "app" / "src" / "main" / "AndroidManifest.xml"
...
def test_android_native_project_uses_corepet_package_namespace():
    ...
    assert ANDROID_MAIN_ACTIVITY.read_text(encoding="utf-8").startswith("package br.com.corepet.app")
    assert ANDROID_MAIN_APPLICATION.read_text(encoding="utf-8").startswith("package br.com.corepet.app")
