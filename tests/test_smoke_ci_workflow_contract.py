...
def test_frontend_package_exposes_core_lint_and_format_scripts():
    ...
    assert (
        ...
        == "eslint src/api src/components/ui src/components/layout src/components/clientes src/components/operadorasCartao src/components/roles src/components/usuarios src/components/pedidosBling src/components/pets src/components/fornecedores src/components/ColumnSelector src/components/Pagination src/components/VariacoesGrid src/components/ModalNovaContaReceber.jsx src/components/pdv src/components/PDVAlertasRacao.jsx src/components/produto src/components/produtos src/components/produtoBalanco src/components/compras src/components/entrada-xml src/components/financeiro src/components/estoque src/components/campanhas src/components/IA src/components/pessoas src/components/racoes src/components/veterinario src/components/AlertasRacao.jsx src/components/ChatIAModal.jsx src/components/ClienteInfoWidget.jsx src/components/ConciliacaoPlanilha.jsx src/components/ContasPagar.jsx src/components/ContasReceber.jsx src/components/DashboardAnaliseRacoes.jsx src/components/EstoqueBling.jsx src/components/EstoqueEntrada.jsx src/components/EstoqueSaida.jsx src/components/FluxoCaixa.jsx src/components/FormasPagamento.jsx src/components/MobileCard.jsx src/components/ModalJustificativa.jsx src/components/ModalLancamentosRecorrentes.jsx src/components/ModalNovaContaPagar.jsx src/components/OpcoesRacao.jsx src/components/RelatorioTaxas.jsx src/components/ResponsiveGrid.jsx src/components/ResponsiveTable.jsx src/components/StatusMargemIndicador.jsx src/components/TabelaConsumoEditor.jsx src/components/TooltipComposicao.jsx src/hooks src/utils src/helpers scripts --max-warnings=0"
    )
    assert (
