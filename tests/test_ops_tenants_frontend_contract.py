...
def test_ops_tenants_frontend_route_nav_and_api_contract():
    ...
    layout_source = (ROOT / "frontend/src/components/OpsLayout.jsx").read_text(encoding="utf-8")
    page_source = (ROOT / "frontend/src/pages/OpsTenants.jsx").read_text(encoding="utf-8")
