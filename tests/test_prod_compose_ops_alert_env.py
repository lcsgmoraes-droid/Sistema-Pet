...
def test_backend_prod_compose_exposes_mercado_pago_checkout_env():
    ...
    expected_env = [
        ...
        "MERCADO_PAGO_OAUTH_CLIENT_ID: ${MERCADO_PAGO_OAUTH_CLIENT_ID:-}",
        "MERCADO_PAGO_OAUTH_CLIENT_SECRET: ${MERCADO_PAGO_OAUTH_CLIENT_SECRET:-}",
        "MERCADO_PAGO_OAUTH_REDIRECT_URI: ${MERCADO_PAGO_OAUTH_REDIRECT_URI:-https://corepet.com.br/api/ecommerce-payment-config/mercadopago/oauth/callback}",
