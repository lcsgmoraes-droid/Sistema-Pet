...
| Configurar NF-e e NFC-e no CorePet | `docs/GUIA_CONFIGURACAO_FISCAL_NFE_NFCE.md` | A1, credenciamento, CSC, vínculo IntNFe, numeração e checklist para produção |
...
| Simular/aplicar seed demo em DEV | `scripts/aplicar_seed_base_demo_marketing.py` | `scripts/test_marketing_demo_seed_apply.py` |
...
| Captura de telas demo | `docs/marketing/PLANO_CAPTURA_TELAS_DEMO.md` |
...
| Dados criticos e LGPD | `docs/CATALOGO_DADOS_CRITICOS_LGPD.md` |
