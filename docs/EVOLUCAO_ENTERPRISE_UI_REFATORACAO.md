...
- 2026-06-03: `produtos_routes.py` retomou a frente de arquivos grandes extraindo helpers de listagem, promocao exibida no PDV, reservas multitenant, area/fornecedor e valorizacao para `backend/app/produtos/listagem.py`, reduzindo o router de 6275 para 6003 linhas com testes focados de listagem/validade/busca preservados. Proximo passo: extrair montagem de load options, ordenacao e paginacao de `listar_produtos` e `listar_produtos_vendaveis`, sem mexer em estoque, fiscal, PDV ou regras de preco.
...
- Existem arquivos extremamente grandes e de alto risco de manutenção:
  ...
  - `backend/app/produtos_routes.py` com `4954` linhas
