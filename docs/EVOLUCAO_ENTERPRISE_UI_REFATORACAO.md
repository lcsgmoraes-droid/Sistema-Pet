...
- Mapa de evolucao enterprise, UI e refatoracao
- Design System UI
...
Ver `docs/EVOLUCAO_ENTERPRISE_UI_REFATORACAO.md#design-system-ui---sistema-pet`.
...
- Atualizar `docs/EVOLUCAO_ENTERPRISE_UI_REFATORACAO.md#design-system-ui---sistema-pet` com tamanhos oficiais de botao/card/tabela.
...
- segue `docs/EVOLUCAO_ENTERPRISE_UI_REFATORACAO.md#design-system-ui---sistema-pet`;
