...
| PDV | Sangria e suprimento do caixa | `/pdv` / menu do caixa | `POST /caixas/{id}/movimentacao` | Sim por revisao de contrato | Sangria e suprimento sao movimentacoes do caixa fisico, nao dependem de banco, conta bancaria ou modulo `financeiro_erp`; origem/destino ficam opcionais. | Ajustada a UI para nao marcar origem/destino como obrigatorios. | OK local |
