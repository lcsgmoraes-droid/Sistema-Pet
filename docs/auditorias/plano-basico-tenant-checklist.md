...
| Cadastros essenciais | Pendente P1 | Operadoras de cartao padronizada visualmente; retestar CRUD de formas de pagamento, operadoras, especies/racas, opcoes de racao e departamentos. |
...
| Cadastros | Opcoes de racao | `/cadastros/opcoes-racao` | Endpoints de opcoes de racao | Parcial | Criacao rapida foi usada/observada, mas selects e persistencia de tabela de consumo precisam de reteste completo. | Nao corrigido nesta branch final. | Pendente P1 |
