...
Tenant demo sugerido desta leva: `demo.atacadaopetpp@sistemapet.local`.
...
- Aplicador dry-run foi executado com `--tenant-email demo.atacadaopetpp@sistemapet.local`.
