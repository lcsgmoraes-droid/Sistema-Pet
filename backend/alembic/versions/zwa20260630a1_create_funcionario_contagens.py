...
def upgrade() -> None:
        ...
        op.create_table(
            ...
            *_tenant_columns(),
            ...
            sa.Column(
                ...
                nullable=False,
                server_default="Contagem",
            ),
            sa.Column("observacao", sa.Text(), nullable=True),
            sa.Column(
                "status", sa.String(length=30), nullable=False, server_default="salva"
            ),
    ...
    if not _has_table("funcionario_contagem_itens"):
        op.create_table(
            ...
            *_tenant_columns(),
            ...
            sa.Column(
                "unidade", sa.String(length=20), nullable=False, server_default="UN"
            ),
    ...
    _create_index(
        "ix_funcionario_contagens_tenant_created",
        "funcionario_contagens",
        ["tenant_id", "created_at"],
    )
    _create_index(
        "ix_funcionario_contagens_tenant_funcionario",
        "funcionario_contagens",
        ["tenant_id", "funcionario_id"],
    )
    _create_index(
        "ix_funcionario_contagens_tenant_fornecedor",
        "funcionario_contagens",
        ["tenant_id", "fornecedor_id"],
    )
    _create_index(
        "ix_funcionario_contagem_itens_tenant_contagem",
        "funcionario_contagem_itens",
        ["tenant_id", "contagem_id"],
    )
    _create_index(
        "ix_funcionario_contagem_itens_tenant_produto",
        "funcionario_contagem_itens",
