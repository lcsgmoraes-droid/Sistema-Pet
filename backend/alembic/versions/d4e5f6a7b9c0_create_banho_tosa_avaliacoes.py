    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.UniqueConstraint(
            ...
            "atendimento_id",
            "cliente_id",
            name="uq_bt_avaliacao_atendimento_cliente",
        ),
    )
    op.create_index(
        "ix_banho_tosa_avaliacoes_tenant_id", "banho_tosa_avaliacoes", ["tenant_id"]
    )
    op.create_index(
        "ix_bt_avaliacoes_atendimento_id", "banho_tosa_avaliacoes", ["atendimento_id"]
    )
    op.create_index(
        "ix_bt_avaliacoes_cliente_id", "banho_tosa_avaliacoes", ["cliente_id"]
    )
    op.create_index("ix_bt_avaliacoes_pet_id", "banho_tosa_avaliacoes", ["pet_id"])
    op.create_index(
        "ix_bt_avaliacoes_cliente_pet",
        "banho_tosa_avaliacoes",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_banho_tosa_avaliacoes_tenant_id", table_name="banho_tosa_avaliacoes"
    )
