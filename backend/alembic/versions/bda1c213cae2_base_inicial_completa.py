...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_configuracao_impostos_id"),
        "configuracao_impostos",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_configuracao_impostos_tenant_id"),
        "configuracao_impostos",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_contexto_financeiro_chat_id"),
        "contexto_financeiro_chat",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contexto_financeiro_chat_tenant_id"),
        "contexto_financeiro_chat",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contexto_financeiro_chat_usuario_id"),
        "contexto_financeiro_chat",
        ["usuario_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_conversas_ia_tenant_id"), "conversas_ia", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_conversas_ia_usuario_id"), "conversas_ia", ["usuario_id"], unique=False
    )
    op.create_table(
        "dre_categorias",
        sa.Column("nome", sa.String(length=100), nullable=False),
        ...
        sa.Column(
            "natureza",
            sa.Enum("RECEITA", "CUSTO", "DESPESA", "RESULTADO", name="naturezadre"),
            nullable=False,
        ),
        sa.Column("ativo", sa.Boolean(), nullable=True),
        sa.Column("id", sa.Integer(), sa.Identity(always=True), nullable=False),
    ...
    op.create_index(
        op.f("ix_dre_categorias_tenant_id"),
        "dre_categorias",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_dre_periodos_usuario_id"), "dre_periodos", ["usuario_id"], unique=False
    )
    op.create_table(
        "especies",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_especies_tenant_id"), "especies", ["tenant_id"], unique=False
    )
    op.create_table(
        "feature_flags",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_feature_flags_feature_key"),
        "feature_flags",
        ["feature_key"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_formas_pagamento_comissoes_id"),
        "formas_pagamento_comissoes",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_user_key",
        "idempotency_keys",
        ["user_id", "chave_idempotencia"],
        unique=False,
    )
    op.create_index(
        op.f("ix_idempotency_keys_chave_idempotencia"),
        "idempotency_keys",
        ["chave_idempotencia"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_indices_mercado_id"), "indices_mercado", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_indices_mercado_setor"), "indices_mercado", ["setor"], unique=False
    )
    op.create_index(
        op.f("ix_indices_mercado_tenant_id"),
        "indices_mercado",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "tipo",
            sa.Enum(
                "CROSS_SELL", "UP_SELL", "RECORRENCIA", name="tipo_oportunidade_enum"
            ),
            nullable=False,
    ...
    op.create_index(
        op.f("ix_opportunities_cliente_id"),
        "opportunities",
        ["cliente_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_opportunities_tipo"), "opportunities", ["tipo"], unique=False
    )
    op.create_table(
        "opportunity_events",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_opportunity_events_event_type"),
        "opportunity_events",
        ["event_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_opportunity_events_opportunity_id"),
        "opportunity_events",
        ["opportunity_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_opportunity_events_tenant_id"),
        "opportunity_events",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_templates_adquirentes_tenant_id"),
        "templates_adquirentes",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "custo_operacional_valor", sa.DECIMAL(precision=10, scale=2), nullable=True
        ),
        sa.Column(
            "custo_operacional_controla_rh_id", sa.String(length=100), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_arquivos_extrato_importados_hash_arquivo"),
        "arquivos_extrato_importados",
        ["hash_arquivo"],
        unique=False,
    )
    op.create_index(
        op.f("ix_arquivos_extrato_importados_id"),
        "arquivos_extrato_importados",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_arquivos_extrato_importados_tenant_id"),
        "arquivos_extrato_importados",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "parceiro_tipo_acerto",
            sa.String(length=20),
            server_default="mensal",
            nullable=False,
        ),
        sa.Column(
            "parceiro_dia_acerto", sa.Integer(), server_default="1", nullable=False
        ),
        sa.Column(
            "parceiro_notificar", sa.Boolean(), server_default="1", nullable=False
        ),
        ...
        sa.Column(
            "valor_padrao_entrega", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "custo_rh_ajustado", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        sa.Column("modelo_custo_entrega", sa.String(length=20), nullable=True),
        sa.Column(
            "taxa_fixa_entrega", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        sa.Column(
            "valor_por_km_entrega", sa.Numeric(precision=10, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_clientes_cargo_id"), "clientes", ["cargo_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_clientes_tenant_id"), "clientes", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_clientes_tipo_cadastro"), "clientes", ["tipo_cadastro"], unique=False
    )
    op.create_index(
        op.f("ix_clientes_tipo_pessoa"), "clientes", ["tipo_pessoa"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_configuracao_tributaria_id"),
        "configuracao_tributaria",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_configuracao_tributaria_tenant_id"),
        "configuracao_tributaria",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_contas_bancarias_ativa"), "contas_bancarias", ["ativa"], unique=False
    )
    op.create_index(
        op.f("ix_contas_bancarias_instituicao_bancaria"),
        "contas_bancarias",
        ["instituicao_bancaria"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_bancarias_tenant_id"),
        "contas_bancarias",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_bancarias_tipo"), "contas_bancarias", ["tipo"], unique=False
    )
    op.create_index(
        op.f("ix_contas_bancarias_user_id"),
        "contas_bancarias",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_departamentos_tenant_id"), "departamentos", ["tenant_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_dre_categorias_analise_id"),
        "dre_categorias_analise",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_dre_categorias_analise_tenant_id"),
        "dre_categorias_analise",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_dre_categorias_analise_usuario_id"),
        "dre_categorias_analise",
        ["usuario_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_dre_comparacoes_id"), "dre_comparacoes", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_dre_comparacoes_tenant_id"),
        "dre_comparacoes",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_dre_comparacoes_usuario_id"),
        "dre_comparacoes",
        ["usuario_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_dre_insights_tenant_id"), "dre_insights", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_dre_insights_usuario_id"), "dre_insights", ["usuario_id"], unique=False
    )
    op.create_table(
        "dre_produtos",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_dre_produtos_produto_id"), "dre_produtos", ["produto_id"], unique=False
    )
    op.create_index(
        op.f("ix_dre_produtos_tenant_id"), "dre_produtos", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_dre_produtos_usuario_id"), "dre_produtos", ["usuario_id"], unique=False
    )
    op.create_table(
        "dre_subcategorias",
        ...
        sa.Column(
            "tipo_custo",
            sa.Enum("DIRETO", "INDIRETO_RATEAVEL", "CORPORATIVO", name="tipocusto"),
            nullable=False,
        ),
        sa.Column(
            "base_rateio",
            sa.Enum(
                "FATURAMENTO", "PEDIDOS", "PERCENTUAL", "MANUAL", name="baserateio"
            ),
            nullable=True,
        ),
        sa.Column(
            "escopo_rateio",
            sa.Enum("LOJA_FISICA", "ONLINE", "AMBOS", name="escoporateio"),
            nullable=False,
        ),
        sa.Column("ativo", sa.Boolean(), nullable=True),
        sa.Column("id", sa.Integer(), sa.Identity(always=True), nullable=False),
    ...
    op.create_index(
        op.f("ix_dre_subcategorias_tenant_id"),
        "dre_subcategorias",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_emails_templates_codigo"), "emails_templates", ["codigo"], unique=True
    )
    op.create_index(
        op.f("ix_emails_templates_id"), "emails_templates", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_emails_templates_tenant_id"),
        "emails_templates",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_emails_templates_user_id"),
        "emails_templates",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_fluxo_usuario_data",
        "fluxo_caixa",
        ["usuario_id", "data_movimentacao"],
        unique=False,
    )
    op.create_index(
        "idx_fluxo_usuario_status",
        "fluxo_caixa",
        ["usuario_id", "status"],
        unique=False,
    )
    op.create_index(
        "idx_fluxo_usuario_tipo", "fluxo_caixa", ["usuario_id", "tipo"], unique=False
    )
    op.create_index(
        op.f("ix_fluxo_caixa_tenant_id"), "fluxo_caixa", ["tenant_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_historico_atualizacao_dre_id"),
        "historico_atualizacao_dre",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_historico_atualizacao_dre_tenant_id"),
        "historico_atualizacao_dre",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_indices_saude_caixa_tenant_id"),
        "indices_saude_caixa",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_listas_preco_tenant_id"), "listas_preco", ["tenant_id"], unique=False
    )
    op.create_table(
        "marcas",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_mensagens_chat_conversa_id"),
        "mensagens_chat",
        ["conversa_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mensagens_chat_id"), "mensagens_chat", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_mensagens_chat_tenant_id"),
        "mensagens_chat",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_notas_entrada_chave_acesso"),
        "notas_entrada",
        ["chave_acesso"],
        unique=True,
    )
    op.create_index(
        op.f("ix_notas_entrada_fornecedor_id"),
        "notas_entrada",
        ["fornecedor_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_notas_entrada_numero_nota"),
        "notas_entrada",
        ["numero_nota"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notas_entrada_status"), "notas_entrada", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_notas_entrada_tenant_id"), "notas_entrada", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_notas_entrada_user_id"), "notas_entrada", ["user_id"], unique=False
    )
    op.create_table(
        "pedidos_compra",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_pedidos_compra_fornecedor_id"),
        "pedidos_compra",
        ["fornecedor_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pedidos_compra_id"), "pedidos_compra", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_pedidos_compra_numero_pedido"),
        "pedidos_compra",
        ["numero_pedido"],
        unique=True,
    )
    op.create_index(
        op.f("ix_pedidos_compra_status"), "pedidos_compra", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_pedidos_compra_tenant_id"),
        "pedidos_compra",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pedidos_compra_user_id"), "pedidos_compra", ["user_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_projecao_fluxo_caixa_tenant_id"),
        "projecao_fluxo_caixa",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_user_tenants_role_id"), "user_tenants", ["role_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "valor_compensado", sa.DECIMAL(precision=10, scale=2), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_acertos_parceiro_data_acerto"),
        "acertos_parceiro",
        ["data_acerto"],
        unique=False,
    )
    op.create_index(
        op.f("ix_acertos_parceiro_id"), "acertos_parceiro", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_acertos_parceiro_parceiro_id"),
        "acertos_parceiro",
        ["parceiro_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_acertos_parceiro_status"), "acertos_parceiro", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_acertos_parceiro_tenant_id"),
        "acertos_parceiro",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_acertos_parceiro_user_id"),
        "acertos_parceiro",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_categorias_financeiras_id"),
        "categorias_financeiras",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_categorias_financeiras_tenant_id"),
        "categorias_financeiras",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_cliente_segmentos_tenant", "cliente_segmentos", ["tenant_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_cliente_segmentos_user_id", "cliente_segmentos", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_cliente_segmentos_id"), "cliente_segmentos", ["id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_comissoes_configuracao_funcionario_id"),
        "comissoes_configuracao",
        ["funcionario_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_comissoes_configuracao_id"),
        "comissoes_configuracao",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["entregador_padrao_id"], ["clientes.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
    ...
    op.create_index(
        op.f("ix_configuracoes_entrega_tenant_id"),
        "configuracoes_entrega",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_configuracoes_entrega_user_id"),
        "configuracoes_entrega",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["conta_bancaria_id"], ["contas_bancarias.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_extratos_bancarios_tenant_id"),
        "extratos_bancarios",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_formas_pagamento_id"), "formas_pagamento", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_formas_pagamento_operadora_id"),
        "formas_pagamento",
        ["operadora_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_formas_pagamento_tenant_id"),
        "formas_pagamento",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "porte_animal", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "fase_publico", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "tipo_tratamento", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        "idx_produtos_categoria", "produtos", ["categoria_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_produtos_tenant_id"), "produtos", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_produtos_variation_signature"),
        "produtos",
        ["variation_signature"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_regras_conciliacao_tenant_id"),
        "regras_conciliacao",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "desconto_percentual", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "percentual_taxa_loja", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
        sa.Column(
            "valor_taxa_entregador", sa.DECIMAL(precision=10, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_vendas_conciliado_vendas"),
        "vendas",
        ["conciliado_vendas"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_vendas_nfe_numero"), "vendas", ["nfe_numero"], unique=False
    )
    op.create_index(
        op.f("ix_vendas_numero_venda"), "vendas", ["numero_venda"], unique=True
    )
    op.create_index(
        op.f("ix_vendas_ordem_entrega_otimizada"),
        "vendas",
        ["ordem_entrega_otimizada"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_comissoes_itens_data_venda"),
        "comissoes_itens",
        ["data_venda"],
        unique=False,
    )
    op.create_index(
        op.f("ix_comissoes_itens_funcionario_id"),
        "comissoes_itens",
        ["funcionario_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_comissoes_itens_id"), "comissoes_itens", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_comissoes_itens_status"), "comissoes_itens", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_comissoes_itens_tenant_id"),
        "comissoes_itens",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_comissoes_itens_venda_id"),
        "comissoes_itens",
        ["venda_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_contas_pagar_canal"), "contas_pagar", ["canal"], unique=False
    )
    op.create_index(
        op.f("ix_contas_pagar_data_vencimento"),
        "contas_pagar",
        ["data_vencimento"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_pagar_dre_subcategoria_id"),
        "contas_pagar",
        ["dre_subcategoria_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_contas_pagar_nota_entrada_id"),
        "contas_pagar",
        ["nota_entrada_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_pagar_status"), "contas_pagar", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_contas_pagar_tenant_id"), "contas_pagar", ["tenant_id"], unique=False
    )
    op.create_table(
        "contas_receber",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_contas_receber_canal"), "contas_receber", ["canal"], unique=False
    )
    op.create_index(
        op.f("ix_contas_receber_conciliacao_recebimento_id"),
        "contas_receber",
        ["conciliacao_recebimento_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_conciliado"),
        "contas_receber",
        ["conciliado"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_data_liquidacao"),
        "contas_receber",
        ["data_liquidacao"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_data_vencimento"),
        "contas_receber",
        ["data_vencimento"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_dre_subcategoria_id"),
        "contas_receber",
        ["dre_subcategoria_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_id"), "contas_receber", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_contas_receber_nsu"), "contas_receber", ["nsu"], unique=False
    )
    op.create_index(
        op.f("ix_contas_receber_status"), "contas_receber", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_contas_receber_status_conciliacao"),
        "contas_receber",
        ["status_conciliacao"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_tenant_id"),
        "contas_receber",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_validacao_id"),
        "contas_receber",
        ["validacao_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contas_receber_venda_id"), "contas_receber", ["venda_id"], unique=False
    )
    op.create_table(
        "email_envios",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_email_envios_data_envio"), "email_envios", ["data_envio"], unique=False
    )
    op.create_index(op.f("ix_email_envios_id"), "email_envios", ["id"], unique=False)
    op.create_index(
        op.f("ix_email_envios_parceiro_id"),
        "email_envios",
        ["parceiro_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_envios_proxima_tentativa"),
        "email_envios",
        ["proxima_tentativa"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_envios_status"), "email_envios", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_email_envios_tenant_id"), "email_envios", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_email_envios_user_id"), "email_envios", ["user_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_formas_pagamento_taxas_id"),
        "formas_pagamento_taxas",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_formas_pagamento_taxas_tenant_id"),
        "formas_pagamento_taxas",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_kit_config_fiscal_tenant_id"),
        "kit_config_fiscal",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_lancamentos_recorrentes_ativo"),
        "lancamentos_recorrentes",
        ["ativo"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_recorrentes_id"),
        "lancamentos_recorrentes",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_recorrentes_tenant_id"),
        "lancamentos_recorrentes",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_recorrentes_tipo"),
        "lancamentos_recorrentes",
        ["tipo"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_lembretes_cliente_id"), "lembretes", ["cliente_id"], unique=False
    )
    op.create_index(
        op.f("ix_lembretes_data_proxima_dose"),
        "lembretes",
        ["data_proxima_dose"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_lembretes_produto_id"), "lembretes", ["produto_id"], unique=False
    )
    op.create_index(
        op.f("ix_lembretes_tenant_id"), "lembretes", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_lembretes_user_id"), "lembretes", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_lembretes_venda_id"), "lembretes", ["venda_id"], unique=False
    )
    op.create_table(
        "movimentacoes_caixa",
    ...
    op.create_index(
        op.f("ix_movimentacoes_caixa_tenant_id"),
        "movimentacoes_caixa",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_movimentacoes_financeiras_conta_bancaria_id"),
        "movimentacoes_financeiras",
        ["conta_bancaria_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_movimentacoes_financeiras_data_movimento"),
        "movimentacoes_financeiras",
        ["data_movimento"],
        unique=False,
    )
    op.create_index(
        op.f("ix_movimentacoes_financeiras_id"),
        "movimentacoes_financeiras",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_movimentacoes_financeiras_status"),
        "movimentacoes_financeiras",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_movimentacoes_financeiras_tenant_id"),
        "movimentacoes_financeiras",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_movimentacoes_financeiras_tipo"),
        "movimentacoes_financeiras",
        ["tipo"],
        unique=False,
    )
    op.create_index(
        op.f("ix_movimentacoes_financeiras_user_id"),
        "movimentacoes_financeiras",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_notas_entrada_itens_id"), "notas_entrada_itens", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_notas_entrada_itens_nota_entrada_id"),
        "notas_entrada_itens",
        ["nota_entrada_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notas_entrada_itens_produto_id"),
        "notas_entrada_itens",
        ["produto_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notas_entrada_itens_tenant_id"),
        "notas_entrada_itens",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_padroes_categorizacao_ia_id"),
        "padroes_categorizacao_ia",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_padroes_categorizacao_ia_tenant_id"),
        "padroes_categorizacao_ia",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_pedidos_compra_itens_id"), "pedidos_compra_itens", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_pedidos_compra_itens_pedido_compra_id"),
        "pedidos_compra_itens",
        ["pedido_compra_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pedidos_compra_itens_produto_id"),
        "pedidos_compra_itens",
        ["produto_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pedidos_compra_itens_tenant_id"),
        "pedidos_compra_itens",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_produto_bling_sync_tenant_id"),
        "produto_bling_sync",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_produto_config_fiscal_tenant_id"),
        "produto_config_fiscal",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_produto_fornecedores_tenant_id"),
        "produto_fornecedores",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_produto_imagens_tenant_id"),
        "produto_imagens",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_kit_componentes_kit", "produto_kit_componentes", ["kit_id"], unique=False
    )
    op.create_index(
        "idx_kit_componentes_produto",
        "produto_kit_componentes",
        ["produto_componente_id"],
        unique=False,
    )
    op.create_index(
        "idx_kit_componentes_unique",
        "produto_kit_componentes",
        ["kit_id", "produto_componente_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_produto_kit_componentes_tenant_id"),
        "produto_kit_componentes",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["lista_preco_id"], ["listas_preco.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["produto_id"], ["produtos.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_produto_listas_preco_tenant_id"),
        "produto_listas_preco",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_produto_lotes_tenant_id"), "produto_lotes", ["tenant_id"], unique=False
    )
    op.create_table(
        "produtos_atributos",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "idx_atributos_produto_pai",
        "produtos_atributos",
        ["produto_pai_id"],
        unique=False,
    )
    op.create_index(
        "idx_atributos_user", "produtos_atributos", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_produtos_atributos_tenant_id"),
        "produtos_atributos",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_produtos_historico_precos_created_at"),
        "produtos_historico_precos",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_produtos_historico_precos_id"),
        "produtos_historico_precos",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_produtos_historico_precos_nota_entrada_id"),
        "produtos_historico_precos",
        ["nota_entrada_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_produtos_historico_precos_produto_id"),
        "produtos_historico_precos",
        ["produto_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_produtos_historico_precos_tenant_id"),
        "produtos_historico_precos",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "distancia_prevista", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "taxa_entrega_cliente", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        sa.Column(
            "valor_repasse_entregador", sa.Numeric(precision=10, scale=2), nullable=True
        ),
        sa.Column("tentativas", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_rotas_entrega_entregador_id"),
        "rotas_entrega",
        ["entregador_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rotas_entrega_numero"), "rotas_entrega", ["numero"], unique=True
    )
    op.create_index(
        op.f("ix_rotas_entrega_status"), "rotas_entrega", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_rotas_entrega_tenant_id"), "rotas_entrega", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_rotas_entrega_venda_id"), "rotas_entrega", ["venda_id"], unique=False
    )
    op.create_table(
        "venda_baixas",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_venda_baixas_tenant_id"), "venda_baixas", ["tenant_id"], unique=False
    )
    op.create_table(
        "venda_pagamentos",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_venda_pagamentos_id"), "venda_pagamentos", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_venda_pagamentos_nsu_cartao"),
        "venda_pagamentos",
        ["nsu_cartao"],
        unique=False,
    )
    op.create_index(
        op.f("ix_venda_pagamentos_operadora_id"),
        "venda_pagamentos",
        ["operadora_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_venda_pagamentos_tenant_id"),
        "venda_pagamentos",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_comissoes_vendas_funcionario_id"),
        "comissoes_vendas",
        ["funcionario_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_comissoes_vendas_id"), "comissoes_vendas", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_comissoes_vendas_tenant_id"),
        "comissoes_vendas",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_comissoes_vendas_venda_id"),
        "comissoes_vendas",
        ["venda_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_estoque_movimentacoes_tenant_id"),
        "estoque_movimentacoes",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_lancamentos_manuais_data_lancamento"),
        "lancamentos_manuais",
        ["data_lancamento"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_manuais_id"), "lancamentos_manuais", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_lancamentos_manuais_status"),
        "lancamentos_manuais",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_manuais_tenant_id"),
        "lancamentos_manuais",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_manuais_tipo"),
        "lancamentos_manuais",
        ["tipo"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["conta_pagar_id"], ["contas_pagar.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["conta_receber_id"], ["contas_receber.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["extrato_id"], ["extratos_bancarios.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["fornecedor_id"],
            ["clientes.id"],
        ...
        sa.ForeignKeyConstraint(
            ["regra_aplicada_id"],
            ["regras_conciliacao.id"],
        ),
        sa.ForeignKeyConstraint(
            ["transferencia_destino_conta_id"],
            ["contas_bancarias.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_movimentacoes_bancarias_tenant_id"),
        "movimentacoes_bancarias",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_pagamentos_conta_pagar_id"),
        "pagamentos",
        ["conta_pagar_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pagamentos_data_pagamento"),
        "pagamentos",
        ["data_pagamento"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_pagamentos_tenant_id"), "pagamentos", ["tenant_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_produtos_atributos_opcoes_tenant_id"),
        "produtos_atributos_opcoes",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("tenant_id", sa.UUID(), nullable=False),
        sa.ForeignKeyConstraint(
            ["conta_receber_id"], ["contas_receber.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["forma_pagamento_id"],
            ["formas_pagamento.id"],
    ...
    op.create_index(
        op.f("ix_recebimentos_conta_receber_id"),
        "recebimentos",
        ["conta_receber_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_recebimentos_data_recebimento"),
        "recebimentos",
        ["data_recebimento"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_recebimentos_tenant_id"), "recebimentos", ["tenant_id"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "distancia_acumulada", sa.Numeric(precision=10, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_rotas_entrega_paradas_rota_id"),
        "rotas_entrega_paradas",
        ["rota_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rotas_entrega_paradas_status"),
        "rotas_entrega_paradas",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rotas_entrega_paradas_tenant_id"),
        "rotas_entrega_paradas",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rotas_entrega_paradas_venda_id"),
        "rotas_entrega_paradas",
        ["venda_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_venda_itens_tenant_id"), "venda_itens", ["tenant_id"], unique=False
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["lancamentos_manuais.id"],
        ),
        sa.ForeignKeyConstraint(
            ["padrao_sugerido_id"],
            ["padroes_categorizacao_ia.id"],
        ),
        sa.ForeignKeyConstraint(
            ["usuario_id"],
            ["users.id"],
    ...
    op.create_index(
        op.f("ix_lancamentos_importados_hash_transacao"),
        "lancamentos_importados",
        ["hash_transacao"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_importados_id"),
        "lancamentos_importados",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_lancamentos_importados_tenant_id"),
        "lancamentos_importados",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_var_atributos_atributo",
        "produtos_variacoes_atributos",
        ["atributo_id"],
        unique=False,
    )
    op.create_index(
        "idx_var_atributos_opcao",
        "produtos_variacoes_atributos",
        ["opcao_id"],
        unique=False,
    )
    op.create_index(
        "idx_var_atributos_unique",
        "produtos_variacoes_atributos",
        ["variacao_id", "atributo_id"],
        unique=True,
    )
    op.create_index(
        "idx_var_atributos_variacao",
        "produtos_variacoes_atributos",
        ["variacao_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_produtos_variacoes_atributos_tenant_id"),
        "produtos_variacoes_atributos",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["movimentacao_real_id"],
            ["movimentacoes_bancarias.id"],
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["regra_id"],
    ...
    op.create_index(
        op.f("ix_provisoes_automaticas_tenant_id"),
        "provisoes_automaticas",
        ["tenant_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_provisoes_automaticas_tenant_id"), table_name="provisoes_automaticas"
    )
    op.drop_table("provisoes_automaticas")
    op.drop_index(
        op.f("ix_produtos_variacoes_atributos_tenant_id"),
        table_name="produtos_variacoes_atributos",
    )
    op.drop_index(
        "idx_var_atributos_variacao", table_name="produtos_variacoes_atributos"
    )
    ...
    op.drop_index(
        "idx_var_atributos_atributo", table_name="produtos_variacoes_atributos"
    )
    op.drop_table("produtos_variacoes_atributos")
    op.drop_index(
        op.f("ix_lancamentos_importados_tenant_id"), table_name="lancamentos_importados"
    )
    op.drop_index(
        op.f("ix_lancamentos_importados_id"), table_name="lancamentos_importados"
    )
    op.drop_index(
        op.f("ix_lancamentos_importados_hash_transacao"),
        table_name="lancamentos_importados",
    )
    ...
    op.drop_index(
        op.f("ix_rotas_entrega_paradas_venda_id"), table_name="rotas_entrega_paradas"
    )
    op.drop_index(
        op.f("ix_rotas_entrega_paradas_tenant_id"), table_name="rotas_entrega_paradas"
    )
    op.drop_index(
        op.f("ix_rotas_entrega_paradas_status"), table_name="rotas_entrega_paradas"
    )
    op.drop_index(
        op.f("ix_rotas_entrega_paradas_rota_id"), table_name="rotas_entrega_paradas"
    )
    ...
    op.drop_index(
        op.f("ix_produtos_atributos_opcoes_tenant_id"),
        table_name="produtos_atributos_opcoes",
    )
    ...
    op.drop_index(
        op.f("ix_movimentacoes_bancarias_tenant_id"),
        table_name="movimentacoes_bancarias",
    )
    op.drop_table("movimentacoes_bancarias")
    op.drop_index(op.f("ix_lancamentos_manuais_tipo"), table_name="lancamentos_manuais")
    op.drop_index(
        op.f("ix_lancamentos_manuais_tenant_id"), table_name="lancamentos_manuais"
    )
    op.drop_index(
        op.f("ix_lancamentos_manuais_status"), table_name="lancamentos_manuais"
    )
    op.drop_index(op.f("ix_lancamentos_manuais_id"), table_name="lancamentos_manuais")
    op.drop_index(
        op.f("ix_lancamentos_manuais_data_lancamento"), table_name="lancamentos_manuais"
    )
    op.drop_table("lancamentos_manuais")
    op.drop_index(
        op.f("ix_estoque_movimentacoes_tenant_id"), table_name="estoque_movimentacoes"
    )
    ...
    op.drop_index(
        op.f("ix_comissoes_vendas_funcionario_id"), table_name="comissoes_vendas"
    )
    op.drop_table("comissoes_vendas")
    op.drop_index(op.f("ix_venda_pagamentos_tenant_id"), table_name="venda_pagamentos")
    op.drop_index(
        op.f("ix_venda_pagamentos_operadora_id"), table_name="venda_pagamentos"
    )
    ...
    op.drop_index(
        op.f("ix_produtos_historico_precos_tenant_id"),
        table_name="produtos_historico_precos",
    )
    op.drop_index(
        op.f("ix_produtos_historico_precos_produto_id"),
        table_name="produtos_historico_precos",
    ...
    op.drop_index(
        op.f("ix_produtos_historico_precos_id"), table_name="produtos_historico_precos"
    )
    op.drop_index(
        op.f("ix_produtos_historico_precos_created_at"),
        table_name="produtos_historico_precos",
    ...
    op.drop_index(
        op.f("ix_produtos_atributos_tenant_id"), table_name="produtos_atributos"
    )
    ...
    op.drop_index(
        op.f("ix_produto_listas_preco_tenant_id"), table_name="produto_listas_preco"
    )
    ...
    op.drop_index(
        op.f("ix_produto_fornecedores_tenant_id"), table_name="produto_fornecedores"
    )
    op.drop_table("produto_fornecedores")
    op.drop_index(
        op.f("ix_produto_config_fiscal_tenant_id"), table_name="produto_config_fiscal"
    )
    op.drop_table("produto_config_fiscal")
    op.drop_index(
        op.f("ix_produto_bling_sync_tenant_id"), table_name="produto_bling_sync"
    )
    op.drop_table("produto_bling_sync")
    op.drop_index(
        op.f("ix_pedidos_compra_itens_tenant_id"), table_name="pedidos_compra_itens"
    )
    op.drop_index(
        op.f("ix_pedidos_compra_itens_produto_id"), table_name="pedidos_compra_itens"
    )
    op.drop_index(
        op.f("ix_pedidos_compra_itens_pedido_compra_id"),
    ...
    op.drop_index(
        op.f("ix_padroes_categorizacao_ia_tenant_id"),
        table_name="padroes_categorizacao_ia",
    )
    op.drop_index(
        op.f("ix_padroes_categorizacao_ia_id"), table_name="padroes_categorizacao_ia"
    )
    op.drop_table("padroes_categorizacao_ia")
    op.drop_index(
        op.f("ix_notas_entrada_itens_tenant_id"), table_name="notas_entrada_itens"
    )
    op.drop_index(
        op.f("ix_notas_entrada_itens_produto_id"), table_name="notas_entrada_itens"
    )
    op.drop_index(
        op.f("ix_notas_entrada_itens_nota_entrada_id"), table_name="notas_entrada_itens"
    )
    ...
    op.drop_index(
        op.f("ix_movimentacoes_financeiras_id"), table_name="movimentacoes_financeiras"
    )
    op.drop_index(
        op.f("ix_movimentacoes_financeiras_data_movimento"),
        table_name="movimentacoes_financeiras",
    ...
    op.drop_index(
        op.f("ix_movimentacoes_caixa_tenant_id"), table_name="movimentacoes_caixa"
    )
    ...
    op.drop_index(
        op.f("ix_lancamentos_recorrentes_tipo"), table_name="lancamentos_recorrentes"
    )
    op.drop_index(
        op.f("ix_lancamentos_recorrentes_tenant_id"),
    ...
    op.drop_index(
        op.f("ix_lancamentos_recorrentes_id"), table_name="lancamentos_recorrentes"
    )
    op.drop_index(
        op.f("ix_lancamentos_recorrentes_ativo"), table_name="lancamentos_recorrentes"
    )
    op.drop_table("lancamentos_recorrentes")
    op.drop_index(
        op.f("ix_kit_config_fiscal_tenant_id"), table_name="kit_config_fiscal"
    )
    op.drop_table("kit_config_fiscal")
    op.drop_index(
        op.f("ix_formas_pagamento_taxas_tenant_id"), table_name="formas_pagamento_taxas"
    )
    op.drop_index(
        op.f("ix_formas_pagamento_taxas_id"), table_name="formas_pagamento_taxas"
    )
    ...
    op.drop_index(
        op.f("ix_contas_receber_status_conciliacao"), table_name="contas_receber"
    )
    ...
    op.drop_index(
        op.f("ix_contas_receber_dre_subcategoria_id"), table_name="contas_receber"
    )
    op.drop_index(
        op.f("ix_contas_receber_data_vencimento"), table_name="contas_receber"
    )
    op.drop_index(
        op.f("ix_contas_receber_data_liquidacao"), table_name="contas_receber"
    )
    ...
    op.drop_index(
        op.f("ix_contas_pagar_dre_subcategoria_id"), table_name="contas_pagar"
    )
    ...
    op.drop_index(
        op.f("ix_comissoes_itens_funcionario_id"), table_name="comissoes_itens"
    )
    ...
    op.drop_index(
        op.f("ix_regras_conciliacao_tenant_id"), table_name="regras_conciliacao"
    )
    ...
    op.drop_index(
        op.f("ix_formas_pagamento_operadora_id"), table_name="formas_pagamento"
    )
    op.drop_index(op.f("ix_formas_pagamento_id"), table_name="formas_pagamento")
    op.drop_table("formas_pagamento")
    op.drop_index(
        op.f("ix_extratos_bancarios_tenant_id"), table_name="extratos_bancarios"
    )
    op.drop_table("extratos_bancarios")
    op.drop_index(
        op.f("ix_configuracoes_entrega_user_id"), table_name="configuracoes_entrega"
    )
    op.drop_index(
        op.f("ix_configuracoes_entrega_tenant_id"), table_name="configuracoes_entrega"
    )
    op.drop_table("configuracoes_entrega")
    op.drop_index(
        op.f("ix_comissoes_configuracao_id"), table_name="comissoes_configuracao"
    )
    op.drop_index(
        op.f("ix_comissoes_configuracao_funcionario_id"),
        table_name="comissoes_configuracao",
    )
    ...
    op.drop_index(
        "idx_cliente_segmentos_tenant_cliente", table_name="cliente_segmentos"
    )
    ...
    op.drop_index(
        op.f("ix_categorias_financeiras_tenant_id"), table_name="categorias_financeiras"
    )
    op.drop_index(
        op.f("ix_categorias_financeiras_id"), table_name="categorias_financeiras"
    )
    ...
    op.drop_index(
        op.f("ix_acertos_parceiro_parceiro_id"), table_name="acertos_parceiro"
    )
    op.drop_index(op.f("ix_acertos_parceiro_id"), table_name="acertos_parceiro")
    op.drop_index(
        op.f("ix_acertos_parceiro_data_acerto"), table_name="acertos_parceiro"
    )
    ...
    op.drop_table("racas")
    op.drop_index(
        op.f("ix_projecao_fluxo_caixa_tenant_id"), table_name="projecao_fluxo_caixa"
    )
    ...
    op.drop_index(
        op.f("ix_indices_saude_caixa_tenant_id"), table_name="indices_saude_caixa"
    )
    op.drop_table("indices_saude_caixa")
    op.drop_index(
        op.f("ix_historico_atualizacao_dre_tenant_id"),
        table_name="historico_atualizacao_dre",
    )
    op.drop_index(
        op.f("ix_historico_atualizacao_dre_id"), table_name="historico_atualizacao_dre"
    )
    ...
    op.drop_index(
        op.f("ix_dre_subcategorias_tenant_id"), table_name="dre_subcategorias"
    )
    ...
    op.drop_index(
        op.f("ix_dre_categorias_analise_usuario_id"),
        table_name="dre_categorias_analise",
    )
    op.drop_index(
        op.f("ix_dre_categorias_analise_tenant_id"), table_name="dre_categorias_analise"
    )
    op.drop_index(
        op.f("ix_dre_categorias_analise_id"), table_name="dre_categorias_analise"
    )
    ...
    op.drop_index(
        op.f("ix_contas_bancarias_instituicao_bancaria"), table_name="contas_bancarias"
    )
    op.drop_index(op.f("ix_contas_bancarias_ativa"), table_name="contas_bancarias")
    op.drop_table("contas_bancarias")
    op.drop_index(
        op.f("ix_configuracao_tributaria_tenant_id"),
        table_name="configuracao_tributaria",
    )
    op.drop_index(
        op.f("ix_configuracao_tributaria_id"), table_name="configuracao_tributaria"
    )
    ...
    op.drop_index(
        op.f("ix_arquivos_extrato_importados_tenant_id"),
        table_name="arquivos_extrato_importados",
    )
    op.drop_index(
        op.f("ix_arquivos_extrato_importados_id"),
        table_name="arquivos_extrato_importados",
    ...
    op.drop_index(
        op.f("ix_templates_adquirentes_tenant_id"), table_name="templates_adquirentes"
    )
    ...
    op.drop_index(
        op.f("ix_opportunity_events_tenant_id"), table_name="opportunity_events"
    )
    op.drop_index(
        "ix_opportunity_events_tenant_created", table_name="opportunity_events"
    )
    op.drop_index(
        op.f("ix_opportunity_events_opportunity_id"), table_name="opportunity_events"
    )
    op.drop_index(
        op.f("ix_opportunity_events_event_type"), table_name="opportunity_events"
    )
    ...
    op.drop_index(
        op.f("ix_idempotency_keys_chave_idempotencia"), table_name="idempotency_keys"
    )
    ...
    op.drop_index(
        op.f("ix_formas_pagamento_comissoes_id"),
        table_name="formas_pagamento_comissoes",
    )
    ...
    op.drop_index(
        op.f("ix_contexto_financeiro_chat_usuario_id"),
        table_name="contexto_financeiro_chat",
    )
    op.drop_index(
        op.f("ix_contexto_financeiro_chat_tenant_id"),
        table_name="contexto_financeiro_chat",
    ...
    op.drop_index(
        op.f("ix_contexto_financeiro_chat_id"), table_name="contexto_financeiro_chat"
    )
    op.drop_table("contexto_financeiro_chat")
    op.drop_index(
        op.f("ix_configuracao_impostos_tenant_id"), table_name="configuracao_impostos"
    )
    op.drop_index(
        op.f("ix_configuracao_impostos_id"), table_name="configuracao_impostos"
    )
