...
def upgrade() -> None:
    if not _has_table("vet_orcamentos"):
        op.create_table(
            ...
            *_tenant_columns(),
            ...
            sa.Column(
                "cliente_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=True
            ),
            sa.Column(
                "veterinario_id",
                sa.Integer(),
            ...
            sa.Column(
                ...
                sa.String(255),
                nullable=False,
                server_default="Orcamento veterinario",
            ),
            sa.Column(
                "status", sa.String(30), nullable=False, server_default="rascunho"
            ),
            ...
            sa.Column(
                "preco_total", sa.Numeric(12, 2), nullable=False, server_default="0"
            ),
            sa.Column(
                "margem_valor", sa.Numeric(12, 2), nullable=False, server_default="0"
            ),
            sa.Column(
                "margem_percentual", sa.Float(), nullable=False, server_default="0"
            ),
        ...
        op.create_table(
            ...
            *_tenant_columns(),
            sa.Column(
                "orcamento_id",
                sa.Integer(),
                sa.ForeignKey("vet_orcamentos.id"),
                nullable=False,
            ),
            sa.Column(
                "catalogo_id",
            ...
            sa.Column(
                "produto_id", sa.Integer(), sa.ForeignKey("produtos.id"), nullable=True
            ),
            ...
            sa.Column(
                "preco_unitario", sa.Numeric(12, 2), nullable=False, server_default="0"
            ),
            sa.Column(
                "custo_total_estimado",
                sa.Numeric(12, 2),
    ...
    _create_index(
        "ix_vet_orcamentos_internacao_id", "vet_orcamentos", ["internacao_id"]
    )
    ...
    _create_index(
        "ix_vet_orcamentos_veterinario_id", "vet_orcamentos", ["veterinario_id"]
    )
    _create_index("ix_vet_orcamentos_status", "vet_orcamentos", ["status"])
    _create_index(
        "ix_vet_orcamentos_tenant_status", "vet_orcamentos", ["tenant_id", "status"]
    )
    _create_index(
        "ix_vet_orcamentos_tenant_consulta",
        "vet_orcamentos",
        ["tenant_id", "consulta_id"],
    )
    _create_index(
        "ix_vet_orcamentos_tenant_internacao",
        "vet_orcamentos",
        ["tenant_id", "internacao_id"],
    )

    _create_index(
        "ix_vet_orcamento_itens_tenant_id", "vet_orcamento_itens", ["tenant_id"]
    )
    _create_index(
        "ix_vet_orcamento_itens_orcamento_id", "vet_orcamento_itens", ["orcamento_id"]
    )
    _create_index(
        "ix_vet_orcamento_itens_catalogo_id", "vet_orcamento_itens", ["catalogo_id"]
    )
    _create_index(
        "ix_vet_orcamento_itens_produto_id", "vet_orcamento_itens", ["produto_id"]
    )
    _create_index(
