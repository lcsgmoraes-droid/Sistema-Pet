"""enable RLS canary on template audit tables

Revision ID: pr20260611a1
Revises: pq20260611a1
...
revision = "pr20260611a1"
down_revision = "pq20260611a1"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    for table_name in CANARY_TABLES:
...
def downgrade() -> None:
    ...
    for table_name in reversed(CANARY_TABLES):
