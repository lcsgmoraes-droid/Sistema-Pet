...
def upgrade() -> None:
    op.create_table(
        ...
        *_tenant_columns(),
        sa.Column(
            "horario_inicio", sa.String(5), nullable=False, server_default="08:00"
        ),
        sa.Column("horario_fim", sa.String(5), nullable=False, server_default="18:00"),
        sa.Column("dias_funcionamento", sa.JSON(), nullable=True),
        sa.Column(
            "intervalo_slot_minutos", sa.Integer(), nullable=False, server_default="30"
        ),
        sa.Column("politica_atraso", sa.Text(), nullable=True),
        sa.Column(
            "tolerancia_encaixe_minutos",
            sa.Integer(),
            nullable=False,
            server_default="15",
        ),
        sa.Column(
            "custo_litro_agua", sa.Numeric(12, 4), nullable=False, server_default="0"
        ),
        sa.Column(
        ...
        sa.Column(
            "custo_toalha_padrao", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column(
        ...
        sa.Column(
            "percentual_taxas_padrao",
            sa.Numeric(7, 4),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "custo_rateio_operacional_padrao",
            sa.Numeric(12, 2),
            nullable=False,
            server_default="0",
        ),
        sa.Column(
            "horas_produtivas_mes_padrao",
            sa.Numeric(8, 2),
            nullable=False,
            server_default="176",
        ),
    ...
    op.create_index(
        "ix_banho_tosa_configuracoes_tenant_id",
        "banho_tosa_configuracoes",
        ["tenant_id"],
    )
    op.create_index(
        "ix_bt_config_tenant_ativo", "banho_tosa_configuracoes", ["tenant_id", "ativo"]
    )
    op.create_index(
        "ix_bt_config_receita_id",
        "banho_tosa_configuracoes",
        ["dre_subcategoria_receita_id"],
    )
    op.create_index(
        "ix_bt_config_custo_id",
        "banho_tosa_configuracoes",
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column(
            "capacidade_simultanea", sa.Integer(), nullable=False, server_default="1"
        ),
    ...
    op.create_index(
        "ix_banho_tosa_recursos_tenant_id", "banho_tosa_recursos", ["tenant_id"]
    )
    op.create_index("ix_bt_recursos_nome", "banho_tosa_recursos", ["nome"])
    op.create_index(
        "ix_bt_recursos_tenant_tipo_ativo",
        "banho_tosa_recursos",
        ["tenant_id", "tipo", "ativo"],
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column(
            "duracao_padrao_minutos", sa.Integer(), nullable=False, server_default="60"
        ),
        sa.Column(
            "requer_banho", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "requer_tosa", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "requer_secagem",
            sa.Boolean(),
    ...
    op.create_index(
        "ix_banho_tosa_servicos_tenant_id", "banho_tosa_servicos", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_bt_servicos_tenant_categoria",
        "banho_tosa_servicos",
        ["tenant_id", "categoria", "ativo"],
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column(
            "agua_padrao_litros", sa.Numeric(12, 3), nullable=False, server_default="0"
        ),
        sa.Column(
            "energia_padrao_kwh", sa.Numeric(12, 4), nullable=False, server_default="0"
        ),
        sa.Column("tempo_banho_min", sa.Integer(), nullable=False, server_default="0"),
        sa.Column(
            "tempo_secagem_min", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column("tempo_tosa_min", sa.Integer(), nullable=False, server_default="0"),
        sa.Column(
            "multiplicador_preco", sa.Numeric(8, 4), nullable=False, server_default="1"
        ),
        sa.Column(
            "ativo", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
    ...
    op.create_index(
        "ix_banho_tosa_parametros_porte_tenant_id",
        "banho_tosa_parametros_porte",
        ["tenant_id"],
    )
    op.create_index("ix_bt_parametros_porte", "banho_tosa_parametros_porte", ["porte"])
    op.create_index(
        "ix_bt_parametros_porte_tenant_ativo",
        "banho_tosa_parametros_porte",
        ["tenant_id", "ativo"],
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        sa.Column(
            "servico_id",
            sa.Integer(),
            sa.ForeignKey("banho_tosa_servicos.id"),
            nullable=False,
        ),
        sa.Column(
            "porte_id",
            sa.Integer(),
            sa.ForeignKey("banho_tosa_parametros_porte.id"),
            nullable=False,
        ),
        sa.Column(
            "tipo_pelagem", sa.String(40), nullable=False, server_default="padrao"
        ),
        sa.Column("preco_base", sa.Numeric(12, 2), nullable=False, server_default="0"),
        sa.Column(
            "tempo_estimado_minutos", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_banho_tosa_precos_servico_tenant_id",
        "banho_tosa_precos_servico",
        ["tenant_id"],
    )
    op.create_index(
        "ix_bt_precos_servico_id", "banho_tosa_precos_servico", ["servico_id"]
    )
    op.create_index("ix_bt_precos_porte_id", "banho_tosa_precos_servico", ["porte_id"])
    op.create_index(
        "ix_bt_precos_tenant_servico",
        "banho_tosa_precos_servico",
        ["tenant_id", "servico_id"],
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        sa.Column(
            "cliente_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=False
        ),
        ...
        sa.Column(
            "banhista_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=True
        ),
        sa.Column(
            "tosador_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=True
        ),
        sa.Column(
            "recurso_id",
            sa.Integer(),
            sa.ForeignKey("banho_tosa_recursos.id"),
            nullable=True,
        ),
        ...
        sa.Column(
            "valor_previsto", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "ix_banho_tosa_agendamentos_tenant_id", "banho_tosa_agendamentos", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_bt_ag_responsavel_id",
        "banho_tosa_agendamentos",
        ["responsavel_agendamento_user_id"],
    )
    op.create_index(
        "ix_bt_ag_profissional_id",
        "banho_tosa_agendamentos",
        ["profissional_principal_id"],
    )
    ...
    op.create_index(
        "ix_bt_ag_data_inicio", "banho_tosa_agendamentos", ["data_hora_inicio"]
    )
    op.create_index("ix_bt_ag_status", "banho_tosa_agendamentos", ["status"])
    op.create_index(
        "ix_bt_agendamentos_tenant_inicio",
        "banho_tosa_agendamentos",
        ["tenant_id", "data_hora_inicio"],
    )
    op.create_index(
        "ix_bt_agendamentos_tenant_status",
        "banho_tosa_agendamentos",
        ["tenant_id", "status"],
    )
    op.create_index(
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        sa.Column(
            "agendamento_id",
            sa.Integer(),
            sa.ForeignKey("banho_tosa_agendamentos.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "servico_id",
        ...
        sa.Column(
            "valor_unitario", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column("desconto", sa.Numeric(12, 2), nullable=False, server_default="0"),
        sa.Column(
            "tempo_previsto_minutos", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_banho_tosa_agendamento_servicos_tenant_id",
        "banho_tosa_agendamento_servicos",
        ["tenant_id"],
    )
    op.create_index(
        "ix_bt_ag_servicos_agendamento_id",
        "banho_tosa_agendamento_servicos",
        ["agendamento_id"],
    )
    op.create_index(
        "ix_bt_ag_servicos_servico_id",
        "banho_tosa_agendamento_servicos",
        ["servico_id"],
    )
    op.create_index(
        "ix_bt_ag_servicos_agendamento",
        "banho_tosa_agendamento_servicos",
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        sa.Column(
            "agendamento_id",
            sa.Integer(),
            sa.ForeignKey("banho_tosa_agendamentos.id"),
            nullable=True,
        ),
        sa.Column(
            "cliente_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=False
        ...
        sa.Column(
            "conta_receber_id",
            sa.Integer(),
            sa.ForeignKey("contas_receber.id"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_banho_tosa_atendimentos_tenant_id", "banho_tosa_atendimentos", ["tenant_id"]
    )
    op.create_index(
        "ix_bt_at_agendamento_id", "banho_tosa_atendimentos", ["agendamento_id"]
    )
    ...
    op.create_index(
        "ix_bt_at_conta_receber_id", "banho_tosa_atendimentos", ["conta_receber_id"]
    )
    op.create_index(
        "ix_bt_at_custo_snapshot_id", "banho_tosa_atendimentos", ["custo_snapshot_id"]
    )
    op.create_index(
        "ix_bt_atendimentos_tenant_status",
        "banho_tosa_atendimentos",
        ["tenant_id", "status"],
    )
    op.create_index(
        "ix_bt_atendimentos_tenant_pet",
        "banho_tosa_atendimentos",
        ["tenant_id", "pet_id"],
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        sa.Column(
            "atendimento_id",
            sa.Integer(),
            sa.ForeignKey("banho_tosa_atendimentos.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("tipo", sa.String(40), nullable=False),
        sa.Column(
            "responsavel_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=True
        ),
        sa.Column(
            "recurso_id",
            sa.Integer(),
    ...
    op.create_index(
        "ix_banho_tosa_etapas_tenant_id", "banho_tosa_etapas", ["tenant_id"]
    )
    op.create_index(
        "ix_bt_etapas_atendimento_id", "banho_tosa_etapas", ["atendimento_id"]
    )
    op.create_index("ix_bt_etapas_tipo", "banho_tosa_etapas", ["tipo"])
    op.create_index(
        "ix_bt_etapas_responsavel_id", "banho_tosa_etapas", ["responsavel_id"]
    )
    op.create_index("ix_bt_etapas_recurso_id", "banho_tosa_etapas", ["recurso_id"])
    op.create_index(
        "ix_bt_etapas_atendimento_tipo",
        "banho_tosa_etapas",
        ["tenant_id", "atendimento_id", "tipo"],
    )
    ...
    op.create_index(
        "ix_bt_fotos_atendimento_id", "banho_tosa_fotos", ["atendimento_id"]
    )
    op.create_index(
        "ix_bt_fotos_atendimento", "banho_tosa_fotos", ["tenant_id", "atendimento_id"]
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        sa.Column(
            "servico_id",
            sa.Integer(),
            sa.ForeignKey("banho_tosa_servicos.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "porte_id",
        ...
        sa.Column(
            "quantidade_padrao", sa.Numeric(12, 4), nullable=False, server_default="0"
        ),
        ...
        sa.UniqueConstraint(
            ...
            "porte_id",
            "produto_id",
            name="uq_bt_insumo_previsto",
        ),
    )
    op.create_index(
        "ix_banho_tosa_insumos_previstos_tenant_id",
        "banho_tosa_insumos_previstos",
        ["tenant_id"],
    )
    op.create_index(
        "ix_bt_insumos_previstos_servico_id",
        "banho_tosa_insumos_previstos",
        ["servico_id"],
    )
    op.create_index(
        "ix_bt_insumos_previstos_porte_id", "banho_tosa_insumos_previstos", ["porte_id"]
    )
    op.create_index(
        "ix_bt_insumos_previstos_produto_id",
        "banho_tosa_insumos_previstos",
        ["produto_id"],
    )
    op.create_index(
        "ix_bt_insumos_previstos_servico_porte",
        "banho_tosa_insumos_previstos",
        ["tenant_id", "servico_id", "porte_id"],
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column(
            "quantidade_prevista", sa.Numeric(12, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "quantidade_usada", sa.Numeric(12, 4), nullable=False, server_default="0"
        ),
        sa.Column(
        ...
        sa.UniqueConstraint(
            ...
            "atendimento_id",
            "produto_id",
            name="uq_bt_insumo_usado_atendimento_produto",
        ),
    )
    op.create_index(
        "ix_banho_tosa_insumos_usados_tenant_id",
        "banho_tosa_insumos_usados",
        ["tenant_id"],
    )
    op.create_index(
        "ix_bt_insumos_usados_atendimento_id",
        "banho_tosa_insumos_usados",
        ["atendimento_id"],
    )
    op.create_index(
        "ix_bt_insumos_usados_produto_id", "banho_tosa_insumos_usados", ["produto_id"]
    )
    op.create_index(
        "ix_bt_insumos_usados_movimentacao_id",
        "banho_tosa_insumos_usados",
        ["movimentacao_estoque_id"],
    )
    op.create_index(
        "ix_bt_insumos_usados_estorno_id",
        "banho_tosa_insumos_usados",
        ["movimentacao_estorno_id"],
    )
    op.create_index(
        "ix_bt_insumos_usados_responsavel_id",
        "banho_tosa_insumos_usados",
        ["responsavel_id"],
    )
    op.create_index(
        "ix_bt_insumos_usados_atendimento",
        "banho_tosa_insumos_usados",
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column(
            "valor_cobrado", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "custo_insumos", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column("custo_agua", sa.Numeric(12, 2), nullable=False, server_default="0"),
        sa.Column(
            "custo_energia", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "custo_mao_obra", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "custo_comissao", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "custo_taxi_dog", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column(
        ...
        sa.Column(
            "margem_valor", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "margem_percentual", sa.Numeric(8, 4), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "ix_banho_tosa_custos_snapshot_tenant_id",
        "banho_tosa_custos_snapshot",
        ["tenant_id"],
    )
    op.create_index(
        "ix_bt_custos_atendimento_id", "banho_tosa_custos_snapshot", ["atendimento_id"]
    )
    op.create_index(
        "ix_bt_custos_tenant_atendimento",
        "banho_tosa_custos_snapshot",
        ["tenant_id", "atendimento_id"],
    )
    ...
    op.create_table(
        ...
        *_tenant_columns(),
        ...
        sa.Column("status", sa.String(40), nullable=False, server_default="agendado"),
        sa.Column(
            "motorista_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=True
        ),
        ...
        sa.Column(
            "custo_estimado", sa.Numeric(12, 2), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "ix_banho_tosa_taxi_dog_tenant_id", "banho_tosa_taxi_dog", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_bt_taxi_agendamento_id", "banho_tosa_taxi_dog", ["agendamento_id"]
    )
    ...
    op.create_index(
        "ix_bt_taxi_rota_entrega_id", "banho_tosa_taxi_dog", ["rota_entrega_id"]
    )
    op.create_index(
        "ix_bt_taxi_tenant_status", "banho_tosa_taxi_dog", ["tenant_id", "status"]
    )
    op.create_index(
        "ix_bt_taxi_tenant_janela",
        "banho_tosa_taxi_dog",
        ["tenant_id", "janela_inicio", "janela_fim"],
    )
