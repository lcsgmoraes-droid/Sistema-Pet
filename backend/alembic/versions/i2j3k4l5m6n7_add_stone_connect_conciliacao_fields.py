...
def upgrade() -> None:
    ...
    op.add_column(
        "stone_configs",
        sa.Column("conciliacao_client_id", sa.String(200), nullable=True),
    )
    op.add_column(
        "stone_configs",
        sa.Column("conciliacao_client_secret", sa.String(200), nullable=True),
    )
    op.add_column(
        "stone_configs", sa.Column("affiliation_code", sa.String(100), nullable=True)
    )
    op.add_column("stone_configs", sa.Column("documento", sa.String(20), nullable=True))
    op.add_column(
        "stone_configs",
        sa.Column("conciliacao_username", sa.String(200), nullable=True),
    )
    op.add_column(
        "stone_configs",
        sa.Column("conciliacao_password_enc", sa.String(500), nullable=True),
    )
