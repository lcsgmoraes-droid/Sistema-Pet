...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "eh_antibiotico", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "eh_controlado", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_index(
        "ix_vet_medicamentos_catalogo_tenant_id",
        "vet_medicamentos_catalogo",
        ["tenant_id"],
    )
    op.create_index(
        "ix_vet_medicamentos_catalogo_nome", "vet_medicamentos_catalogo", ["nome"]
    )
    op.create_index(
        "ix_vet_medicamentos_catalogo_principio_ativo",
        "vet_medicamentos_catalogo",
        ["principio_ativo"],
    )
    ...
    op.create_index(
        "ix_vet_protocolos_vacinas_tenant_id", "vet_protocolos_vacinas", ["tenant_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "veterinario_id", sa.Integer(), sa.ForeignKey("clientes.id"), nullable=True
        ),
        ...
        sa.Column(
            "status", sa.String(30), nullable=False, server_default="em_andamento"
        ),
        ...
        sa.Column(
            "finalizado_por_id", sa.Integer(), sa.ForeignKey("users.id"), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "is_emergencia", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("sintoma_emergencia", sa.String(255), nullable=True),
        sa.Column(
            "consulta_id",
            sa.Integer(),
            sa.ForeignKey("vet_consultas.id"),
            nullable=True,
        ),
        sa.Column("inicio_atendimento", sa.DateTime(timezone=True), nullable=True),
        sa.Column("fim_atendimento", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index(
        "ix_vet_prescricoes_consulta_id", "vet_prescricoes", ["consulta_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "prescricao_id",
            sa.Integer(),
            sa.ForeignKey("vet_prescricoes.id"),
            nullable=False,
        ),
        sa.Column(
            "medicamento_catalogo_id",
            sa.Integer(),
            sa.ForeignKey("vet_medicamentos_catalogo.id"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_vet_itens_prescricao_tenant_id", "vet_itens_prescricao", ["tenant_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "protocolo_id",
            sa.Integer(),
            sa.ForeignKey("vet_protocolos_vacinas.id"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_vet_vacinas_registros_tenant_id", "vet_vacinas_registros", ["tenant_id"]
    )
    op.create_index(
        "ix_vet_vacinas_registros_pet_id", "vet_vacinas_registros", ["pet_id"]
    )
    op.create_index(
        "ix_vet_vacinas_registros_data_proxima_dose",
        "vet_vacinas_registros",
        ["data_proxima_dose"],
    )
    ...
    op.create_index(
        "ix_vet_catalogo_procedimentos_tenant_id",
        "vet_catalogo_procedimentos",
        ["tenant_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "catalogo_id",
            sa.Integer(),
            sa.ForeignKey("vet_catalogo_procedimentos.id"),
            nullable=True,
        ),
        sa.Column("user_id", sa.Integer(), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("nome", sa.String(255), nullable=False),
    ...
    op.create_index(
        "ix_vet_procedimentos_consulta_tenant_id",
        "vet_procedimentos_consulta",
        ["tenant_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "internacao_id",
            sa.Integer(),
            sa.ForeignKey("vet_internacoes.id"),
            nullable=False,
        ),
        sa.Column("user_id", sa.Integer(), sa.ForeignKey("users.id"), nullable=False),
        sa.Column(
    ...
    op.create_index(
        "ix_vet_evolucoes_internacao_tenant_id",
        "vet_evolucoes_internacao",
        ["tenant_id"],
    )
    op.create_index(
        "ix_vet_evolucoes_internacao_internacao_id",
        "vet_evolucoes_internacao",
        ["internacao_id"],
    )
    ...
    op.create_index(
        "ix_vet_peso_registros_tenant_id", "vet_peso_registros", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_vet_fotos_clinicas_tenant_id", "vet_fotos_clinicas", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_vet_perfil_comportamental_tenant_id",
        "vet_perfil_comportamental",
        ["tenant_id"],
    )
