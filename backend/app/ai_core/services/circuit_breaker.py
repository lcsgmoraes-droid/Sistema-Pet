...
class AICircuitBreaker:
    ...
    def record_violation(
        self, severity: GuardrailSeverity, violation_event_id: str, reason: str
    ) -> CircuitState:
        """
    ...
    def _open_circuit(
        self, violation_event_id: Optional[str], reason: str, emergency: bool
    ) -> CircuitState:
        """
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_opened_at": self._last_opened_at.isoformat()
            if self._last_opened_at
            else None,
        }
