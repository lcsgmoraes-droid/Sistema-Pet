...
from .produtos.normalizacao import (
    ...
    normalizar_promocao_erp_payload as _normalizar_promocao_erp_payload,
    normalizar_sku_produto as _normalizar_sku_produto,
    produto_sku_value as _produto_sku_value,
)
