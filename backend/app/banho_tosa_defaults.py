...
SERVICOS_PADRAO = [
    (
        "Banho Higienico",
        "banho",
        "Banho simples com shampoo, secagem e finalizacao basica.",
        60,
        "85.00",
        True,
        False,
    ...
    (
        "Banho Completo",
        "banho",
        "Banho completo com limpeza de ouvidos e acabamento.",
        75,
        "120.00",
        True,
        False,
    ...
    (
        ...
        "combo",
        "Banho completo com tosa higienica de patas, barriga e partes intimas.",
        90,
        "145.00",
        True,
        True,
    ...
    (
        "Tosa na Maquina",
        "tosa",
        "Tosa padronizada na maquina, sem banho obrigatorio.",
        75,
        "110.00",
        False,
        True,
    ...
    (
        "Tosa Completa",
        "combo",
        "Banho, secagem e tosa completa com acabamento.",
        120,
        "180.00",
        True,
        True,
    ...
    (
        "Desembaraco",
        "higiene",
        "Servico adicional para nos e pelagem embaracada.",
        45,
        "45.00",
        False,
        False,
    ...
    (
        "Corte de Unhas",
        "higiene",
        "Corte e conferencia rapida das unhas.",
        15,
        "25.00",
        False,
        False,
    ...
    (
        ...
        "higiene",
        "Tratamento adicional aplicado junto ao banho.",
        30,
        "40.00",
        True,
        False,
...
def aplicar_base_padrao_banho_tosa(db: Session, tenant_id) -> dict:
    ...
    db.commit()
    resumo["mensagem"] = (
        "Base padrao aplicada. Os registros criados podem ser editados normalmente."
    )
    return resumo
...
def _criar_parametros(db: Session, tenant_id, resumo: dict) -> None:
    for item in PARAMETROS_PORTE_PADRAO:
        porte = item[0]
        existe = (
            db.query(BanhoTosaParametroPorte.id)
            .filter(
...
def _criar_templates(db: Session, tenant_id, resumo: dict) -> None:
    for nome, tipo_retorno, canal, assunto, mensagem in TEMPLATES_RETORNO_PADRAO:
        existe = (
            db.query(BanhoTosaRetornoTemplate.id)
            .filter(
