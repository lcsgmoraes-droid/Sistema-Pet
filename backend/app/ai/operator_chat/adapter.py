...
def montar_contexto_para_ai(operator_context: OperatorChatContext) -> Dict[str, Any]:
    """
...
def preparar_contexto_completo(operator_context: OperatorChatContext) -> Dict[str, Any]:
    """
