...
class PerformanceParceiro(BaseTenantModel):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_perf_tenant_mes_ranking", "tenant_id", "mes_referencia", "ranking_mes"
        ),
    )
...
class ReceitaMensal(BaseTenantModel):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "ticket_medio": float(self.ticket_medio),
            "variacao_percentual": float(self.variacao_percentual)
            if self.variacao_percentual
            else None,
            "atualizado_em": self.atualizado_em.isoformat()
            if self.atualizado_em
            else None,
