...
from .handlers import LogEventHandler, AuditoriaEventHandler, IAEventHandler
...
def setup_event_handlers(db_session_factory=None) -> None:
    ...
    if db_session_factory:
        ...
        event_dispatcher.subscribe(
            VendaFinalizada, auditoria_handler.on_venda_finalizada
        )
        ...
        logger.warning(
            "   ⚠️  AuditoriaEventHandler NÃO registrado (sem db_session_factory)"
        )
    ...
    event_dispatcher.subscribe(
        VendaFinalizada, KitEstoqueEventHandler.on_venda_finalizada
    )
    event_dispatcher.subscribe(
        VendaCancelada, KitEstoqueEventHandler.on_venda_cancelada
    )
