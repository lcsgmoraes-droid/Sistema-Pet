...
from app.services.tenant_onboarding_templates import (
    ...
    BUILTIN_TEMPLATE_ITEMS as BUILTIN_TEMPLATE_ITEMS,
    ...
    REQUIRED_ONBOARDING_TABLES as REQUIRED_ONBOARDING_TABLES,
    REQUIRED_TEMPLATE_ITEM_TYPES as REQUIRED_TEMPLATE_ITEM_TYPES,
    TEMPLATE_INFRA_TABLES as TEMPLATE_INFRA_TABLES,
