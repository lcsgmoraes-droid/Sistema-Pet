...
class BanhoTosaPacote(BaseTenantModel):
    ...
    servico_id = Column(
        Integer, ForeignKey("banho_tosa_servicos.id"), nullable=True, index=True
    )
...
class BanhoTosaPacoteCredito(BaseTenantModel):
    ...
    pacote_id = Column(
        Integer, ForeignKey("banho_tosa_pacotes.id"), nullable=False, index=True
    )
...
class BanhoTosaPacoteMovimento(BaseTenantModel):
    ...
    credito_id = Column(
        Integer,
        ForeignKey("banho_tosa_pacote_creditos.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    atendimento_id = Column(
        Integer, ForeignKey("banho_tosa_atendimentos.id"), nullable=True, index=True
    )
    movimento_origem_id = Column(
        Integer,
...
class BanhoTosaRecorrencia(BaseTenantModel):
    ...
    __table_args__ = (
        Index("ix_bt_recorrencias_proxima", "tenant_id", "ativo", "proxima_execucao"),
    )
