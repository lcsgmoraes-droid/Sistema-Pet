...
class Cargo(BaseTenantModel):
    ...
    regime_remuneracao = Column(
        String(30), nullable=False, default="clt", server_default="clt"
    )
    ...
    inss_funcionario_percentual = Column(
        Numeric, nullable=False, default=0, server_default="0"
    )
    inss_funcionario_valor = Column(
        Numeric, nullable=False, default=0, server_default="0"
    )
    desconto_transporte_valor = Column(
        Numeric, nullable=False, default=0, server_default="0"
    )
    outros_descontos_valor = Column(
        Numeric, nullable=False, default=0, server_default="0"
    )
