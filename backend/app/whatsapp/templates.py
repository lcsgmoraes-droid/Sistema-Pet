...
class ResponseFormatter:
    ...
    def format_produtos(self, produtos: list, query: str = "") -> str:
        ...
        return template.format(total=len(produtos), produtos_list=produtos_str)
    ...
    def format_horarios_disponiveis(
        self, servico: str, data: str, horarios: list
    ) -> str:
        ...
        return template.format(
            servico=servico.title(), data=data, horarios=horarios_str
        )

    def format_agendamento_confirmado(
        self, data: str, horario: str, servico: str, pet_nome: str
    ) -> str:
        """Formata confirmação de agendamento"""
        template = RESPONSE_TEMPLATES[IntentType.AGENDAMENTO]["confirmado"]
        return template.format(
            data=data, horario=horario, servico=servico.title(), pet_nome=pet_nome
        )
    ...
    def get_template(
        self, intent: IntentType, template_key: str = "default", **kwargs
    ) -> str:
        """
