...
class RateLimiter:
    ...
    def check_rate_limit(
        self, identifier: str, limit_type: str = "ip_per_minute"
...
class SecurityAuditLog(TenantScoped, Base):
    ...
    )  # login, logout, failed_login, permission_denied, etc
    severity = Column(
    ...
    extra_data = Column(
        Text
    )  # JSON adicional (evita conflito com 'metadata' reservado)
...
class LGPDService:
    ...
    def revoke_consent(self, subject_id: str, consent_type: str) -> bool:
    ...
    def export_user_data(
        self, subject_id: str, subject_type: str = "customer"
    ) -> Dict[str, Any]:
        """
