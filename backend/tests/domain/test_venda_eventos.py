...
class TestEventoVendaCriada:
    ...
    def test_evento_venda_criada_inclui_metadados(
        ...
        with (
            ...
            assert evento.metadados["subtotal"] == pytest.approx(100.0)
...
class TestEventoVendaFinalizada:
    ...
    def test_evento_venda_finalizada_eh_emitido(
        ...
        with (
            ...
            # ASSERT
            eventos_finalizadas = [
                e for e in eventos_publicados if isinstance(e, VendaFinalizada)
            ]
    ...
    def test_evento_venda_finalizada_inclui_formas_pagamento(
        ...
        with (
            ...
            with patch(
                "app.domain.events.publish_event",
                side_effect=lambda e: eventos_publicados.append(e),
            ):
                # ACT
                VendaService.finalizar_venda(
                    venda_id=100,
            ...
            # ASSERT
            evento = [e for e in eventos_publicados if isinstance(e, VendaFinalizada)][
                0
            ]
...
class TestEventoVendaCancelada:
    ...
    def test_evento_venda_cancelada_eh_emitido(
        ...
        with (
            ...
            # ASSERT
            eventos_canceladas = [
                e for e in eventos_publicados if isinstance(e, VendaCancelada)
            ]
