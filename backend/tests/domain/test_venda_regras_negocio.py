...
class TestRegrasCriacaoVenda:
    ...
    def test_nao_criar_venda_com_itens_none(self, mock_db_session):
        ...
        ESPERA: HTTPException 400
        """
        payload = {"cliente_id": 1, "itens": None}
...
class TestRegrasFinalizacaoVenda:
    ...
    def test_nao_finalizar_venda_inexistente(self, mock_db_session, mock_caixa_service):
        """
    ...
    def test_nao_finalizar_venda_ja_totalmente_paga(
        ...
        with (
            ...
            mock_db_session.query(
                MockPagamento
            ).filter_by.return_value.all.return_value = [pag_existente]
...
class TestRegrasCancelamentoVenda:
    ...
    def test_nao_cancelar_venda_ja_cancelada(self, mock_db_session, fake_venda_model):
        """
    ...
    def test_cancelamento_falha_rollback_completo(
        ...
        with (
            ...
            mock_estoque_service.estornar_estoque.side_effect = Exception(
                "Erro no estoque"
            )
