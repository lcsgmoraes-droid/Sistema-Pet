...
def test_analise_pagamento_usa_configuracao_real_de_comissao():
    source = (REPO_ROOT / "backend/app/formas_pagamento_routes.py").read_text(encoding="utf-8")
...
def test_modal_pagamento_envia_vendedor_para_analise_de_margem():
    source = (REPO_ROOT / "frontend/src/components/ModalPagamento.jsx").read_text(encoding="utf-8")
