...
def test_resolver_customer_id_usa_codigo_quando_id_interno_nao_existe():
    ...
    assert _resolver_customer_id_campanhas(db, tenant_id="tenant-1", customer_ref=10001) == 732
...
def test_resolver_customer_id_mantem_id_interno_quando_existe():
    ...
    assert _resolver_customer_id_campanhas(db, tenant_id="tenant-1", customer_ref=55) == 55
