    ...
    try:
        for template_data in templates:
            ...
            existe = (
                ...
                .filter(
                    and_(
                        TemplateAdquirente.nome_adquirente
                        == template_data["nome_adquirente"],
                        TemplateAdquirente.tipo_relatorio
                        == template_data["tipo_relatorio"],
                    )
                )
                .first()
            )
            ...
            if existe:
                print(
                    f"✓ Template '{template_data['nome_adquirente']} - {template_data['tipo_relatorio']}' já existe"
                )
                continue
            ...
            db.add(template)
            print(
                f"✓ Template '{template_data['nome_adquirente']} - {template_data['tipo_relatorio']}' criado"
            )
