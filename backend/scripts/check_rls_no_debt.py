...
from app.tenancy.rls_no_debt import assert_no_unexpected_no_rls_tables, tenant_id_tables_without_rls
...
def main() -> int:
    ...
    if remaining:
        print("RLS no-debt OK. Intentional globals without RLS:", ", ".join(sorted(remaining)))
    else:
