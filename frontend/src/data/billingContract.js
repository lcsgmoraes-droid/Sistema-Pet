...
function contractSection(title, body, bullets) {
...
export const billingContract = {
  ...
  sections: [
    ...
    contractSection(
      ...
      "A CorePet disponibiliza acesso remoto à plataforma em modelo de software como serviço (SaaS), conforme os módulos e limites do plano contratado.",
      [
    ...
    contractSection(
      "3. Aceite eletrônico e representação",
      "O contrato é celebrado quando o administrador visualiza o resumo da contratação, acessa estes documentos, marca o campo de concordância e confirma a assinatura.",
      [
    ...
    contractSection(
      "4. Período gratuito e início da cobrança",
      "Quando oferecido, o período gratuito terá a duração e o escopo informados na plataforma. O teste não se converte automaticamente em plano pago e não autoriza cobrança sem o aceite expresso do administrador.",
      [
    ...
    contractSection(
      "5. Plano, preço e cobrança",
      "A mensalidade, o ciclo, a forma de pagamento e o primeiro vencimento são os exibidos no resumo aceito. A cobrança poderá ser processada pelo Asaas ou por outro provedor informado.",
      [
    ...
    contractSection(
      "6. Reajuste anual",
      "Os valores da assinatura serão reajustados a cada 12 meses, contados do início da assinatura paga ou do último reajuste, pela variação acumulada do IPCA divulgado pelo IBGE. A periodicidade de reajuste nunca será inferior a 12 meses.",
      [
    ...
    contractSection(
      "7. Obrigações da CorePet",
      "A CorePet prestará o serviço com diligência técnica, segurança proporcional ao risco e respeito aos recursos contratados.",
      [
    ...
    contractSection(
      ...
      "A contratante é responsável pela administração da conta, pela qualidade das informações inseridas e pelo uso lícito da plataforma por seus usuários.",
      [
    ...
    contractSection(
      "9. Suporte, disponibilidade, manutenção e terceiros",
      "A CorePet busca manter a plataforma disponível e corrigir falhas sob seu controle, mas a assinatura padrão não contém garantia numérica de disponibilidade nem prazo garantido de resolução, salvo quando houver SLA específico aceito pelas partes.",
      [
    ...
    contractSection(
      "10. Dados, segurança, incidentes e confidencialidade",
      "A contratante mantém seus direitos sobre os dados e conteúdos inseridos na plataforma. A CorePet poderá tratá-los na medida necessária para executar, proteger e dar suporte ao serviço, respeitando os papéis definidos na legislação e na Política de Privacidade.",
      [
    ...
    contractSection(
      "11. Propriedade intelectual, personalizações e sugestões",
      "O software, a marca, o código, as interfaces, os modelos e a documentação pertencem à CorePet ou aos respectivos licenciantes. O contrato concede apenas o direito de uso durante a assinatura.",
      [
    ...
    contractSection(
      "12. Escopo, implantação e controle de mudanças",
      "A CorePet deve entregar o escopo registrado na proposta aceita. Necessidades não descritas, mudanças posteriores e novas integrações não entram automaticamente na mensalidade ou no prazo original.",
      [
    ...
    contractSection(
      "13. Suspensão, cancelamento, exportação e encerramento",
      "A CorePet poderá suspender o acesso em caso de inadimplência, risco de segurança, fraude, ordem legal, violação grave ou ameaça à estabilidade, com aviso e oportunidade razoável de regularização sempre que a urgência permitir.",
      [
    ...
    contractSection(
      "14. Responsabilidades, limite e força maior",
      "Cada parte responde pelos danos diretos que causar por descumprimento de suas obrigações, conforme prova, nexo causal e legislação aplicável. Nenhuma disposição afasta responsabilidade que não possa ser limitada por lei.",
      [
    ...
    contractSection(
      "15. Alterações, comunicações e solução de conflitos",
      "Alterações materiais serão comunicadas com antecedência razoável. Mudança extraordinária de preço, inclusão de fidelidade, redução relevante de direitos ou ampliação material de responsabilidade exigirá novo aceite ou proposta específica.",
      [
