          ...
          >
            ...
            {selecionadas.length > 0 && (
              ...
              >
                {otimizando
                  ? "🔄 Otimizando..."
                  : `🗺️ Otimizar Selecionadas (${selecionadas.length})`}
              </button>
            )}
            <span style={{ color: "#666", fontSize: "0.9em" }}>
              ℹ️{" "}
              {vendas.filter((v) => v.ordem_otimizada).length > 0
              ...
              <tr>
                <th style={{ width: 40 }}>
                  <input
                    ...
                    onChange={(e) =>
                      setSelecionadas(e.target.checked ? vendas.map((v) => v.id) : [])
                    }
                  />
                </th>
                <th>Ordem</th>
