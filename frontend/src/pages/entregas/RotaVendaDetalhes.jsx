    ...
    >
      {loading ? (
        ...
        <>
          ...
          >
            <h4 style={{ margin: 0, color: "#007BFF" }}>🧾 Detalhes da Venda #{venda.id}</h4>
            <button
              onClick={onFechar}
              style={{
                background: "#dc3545",
          ...
          >
            ...
            >
              ...
              <div>
                <strong>📅 Data:</strong>{" "}
                {venda.data_venda ? new Date(venda.data_venda).toLocaleString("pt-BR") : "N/A"}
              </div>
              ...
              {venda.cliente?.celular && (
                <div>
                  <strong>📱 Celular:</strong> {venda.cliente.celular}
                </div>
              )}
              {venda.cliente?.email && (
          ...
          >
            ...
            >
              ...
              >
                R$ {parseFloat(venda.valor_total || venda.total || 0).toFixed(2)}
              </div>
            </div>
            <div
              style={{
          ...
          {venda.endereco_entrega && (
            ...
            >
              ...
              <div style={{ color: "#424242", fontSize: 14 }}>{venda.endereco_entrega}</div>
            </div>
          )}
          ...
          {venda.observacoes && (
            ...
            >
              ...
              <div style={{ color: "#424242", fontSize: 14 }}>{venda.observacoes}</div>
            </div>
          )}
              ...
              >
                {venda.itens.map((item, idx) => (
                  <div
                    ...
                    style={{
                      padding: 12,
                      borderBottom: idx < venda.itens.length - 1 ? "1px solid #eee" : "none",
                      display: "flex",
                      justifyContent: "space-between",
                      alignItems: "center",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {item.quantidade} × R${" "}
                        {parseFloat(item.valor_unitario || item.preco_unitario || 0).toFixed(2)}
                      </div>
                      <div
                        style={{
                          fontSize: 15,
