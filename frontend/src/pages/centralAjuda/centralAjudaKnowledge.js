    ...
    artigos: [
      {
        ...
        tags: ["granel", "bipagem", "produto fechado", "estoque", "app funcionario"],
        conteudo: [
          "Para conferir ou criar o vínculo no ERP, acesse **Produtos / Estoque → Listar Produtos**, abra o produto fechado de origem, clique em **Ver movimentações de estoque → Lançar granel** e selecione o produto a granel. Um mesmo produto a granel pode receber vínculos de embalagens diferentes, como 10 kg, 15 kg e 20 kg.",
          "No ERP, abra **Configurações → Estoque** para decidir se a bipagem será obrigatória.",
          "No app do funcionário, abra **Lançar granel**, bipe primeiro o produto fechado e depois o produto a granel.",
          "O sistema mostra **Tudo certo** somente quando a combinação estiver vinculada. Uma combinação diferente é recusada.",
          "Informe quantas embalagens foram abertas e confirme. O estoque do produto fechado diminui e o estoque do produto a granel recebe o peso correspondente em kg.",
  ...
  // ────────────── PDV / VENDAS ──────────────
  {
    ...
    artigos: [
      ...
      },
      {
        ...
        titulo: "Como configurar e usar o crediário no ERP e no app",
        tags: [
          "crediario",
          "vencimento",
          "contas a receber",
        ...
        conteudo: [
          "**1. Ative ou desative no ERP:** o **Crediário já é criado automaticamente** para a empresa. Acesse **Cadastros → Formas de Pagamento**, localize **Crediário** e use o campo **Ativo**. Não é necessário criar outra forma com esse nome.",
          "A mesma configuração controla as duas telas: se o Crediário estiver ativo, aparece como forma de pagamento no **ERP** e no **app do funcionário**; se estiver desativado, fica oculto nos dois.",
          "**2. Venda pelo ERP:** acesse **PDV (Vendas)**, selecione obrigatoriamente o cliente, adicione os produtos e abra a etapa de pagamento. Escolha **Crediário**, informe a **primeira data** no formato **DD-MM-AAAA**, a quantidade de parcelas e, quando houver mais de uma, o intervalo de **7 dias**, **15 dias** ou **Mensal**.",
          "Confira a prévia com o número, o valor e o vencimento de cada parcela. A última parcela absorve eventual diferença de centavos. Depois, adicione o pagamento e conclua a venda.",
          "**3. Venda pelo app do funcionário:** abra **Funcionário → Passar venda**, adicione os produtos e selecione a pessoa na área **Comprador**. Se for um cliente novo, use o botão **+** para cadastrá-lo. Em **Pagamento**, escolha **Crediário** e preencha os mesmos campos do ERP: primeira data, quantidade e intervalo. Confira a prévia e toque em **Finalizar**.",
          "A seleção do cliente é obrigatória somente quando a forma escolhida for Crediário, porque a dívida e o aviso precisam ficar ligados ao cadastro correto.",
          "No intervalo **Mensal**, o sistema preserva o dia escolhido. Se o mês não tiver esse dia, usa o último dia válido daquele mês e volta ao dia original no próximo mês possível; por exemplo, 31/01, 28/02 e 31/03.",
          "**4. Depois da venda:** o valor não entra como dinheiro recebido no caixa. O sistema cria automaticamente uma pendência para cada parcela em **Financeiro → Contas a Receber**, identificada como **1/3**, **2/3**, **3/3** e assim por diante.",
          "O ERP passa a mostrar as pendências e os avisos conforme cada vencimento. O cliente que usa o app recebe um aviso por parcela e pode acompanhar cada valor, situação e vencimento em **Pedidos → Crediário**.",
          "**5. Quando o cliente pagar:** acesse **Financeiro → Contas a Receber**, localize o lançamento do cliente e use a ação de recebimento adequada. Registre a forma e a data do pagamento para baixar o saldo em aberto.",
          "Se o Crediário não aparecer no ERP ou no app do funcionário, confira primeiro se ele está **Ativo** em **Cadastros → Formas de Pagamento** e atualize a tela.",
        ],
      },
      {
