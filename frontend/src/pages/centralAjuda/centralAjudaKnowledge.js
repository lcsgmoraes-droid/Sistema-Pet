    ...
    artigos: [
      ...
      },
      {
        ...
        conteudo: [
          ...
          "**2. Venda pelo ERP:** acesse **PDV (Vendas)**, selecione obrigatoriamente o cliente, adicione os produtos e abra a etapa de pagamento. Escolha **Crediário**, informe a data combinada no formato **DD-MM-AAAA**, adicione o pagamento e conclua a venda.",
          "**3. Venda pelo app do funcionário:** abra **Funcionário → Passar venda**, adicione os produtos e selecione a pessoa na área **Comprador**. Se for um cliente novo, use o botão **+** para cadastrá-lo. Em **Pagamento**, escolha **Crediário**, informe o vencimento em **DD-MM-AAAA** e toque em **Finalizar**.",
          ...
          "**4. Depois da venda:** o valor não entra como dinheiro recebido no caixa. O sistema cria automaticamente um lançamento pendente em **Financeiro → Contas a Receber**, com o cliente, o valor e a data de vencimento informada.",
          "O ERP passa a mostrar a pendência e os avisos conforme o vencimento. O cliente que usa o app recebe uma notificação e pode acompanhar saldo, situação e vencimento em **Pedidos → Crediário**.",
