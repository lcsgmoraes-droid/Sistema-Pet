    ...
    artigos: [
      ...
      },
      {
        ...
        conteudo: [
          ...
          "A reposição é uma simulação: ela não movimenta estoque nem cria pedidos automaticamente. Confira os custos e use a transferência integrada ou o pedido de compra da empresa indicada para executar a decisão.",
