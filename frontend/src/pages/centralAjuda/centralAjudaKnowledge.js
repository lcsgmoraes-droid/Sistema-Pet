    ...
    artigos: [
      ...
      },
      {
        ...
        conteudo: [
          ...
          "O cliente também recebe o aviso de reposição pelo app CorePet conforme a antecedência calculada.",
      ...
      },
      {
        ...
        conteudo: [
          "**Objetivo:** medir quantas pessoas saíram sem comprar, entender os motivos e descobrir quais produtos a loja deixou de vender, inclusive itens que ainda não existem no catálogo.",
          "Acesse **PDV (Vendas)** e clique em **Registrar procura** no alto da tela. O botão funciona com ou sem cliente selecionado na venda atual.",
          "Na aba **Registrar agora**, o cliente é opcional. Você pode deixá-lo anônimo, selecionar um cadastro existente ou anotar somente nome e telefone para manter o vínculo com o produto procurado.",
          "Em **Produtos procurados**, selecione um item do catálogo ou escreva livremente o nome, a marca e o fornecedor. Use **Outro produto** quando a mesma pessoa procurou mais de um item. O produto também é opcional quando você quer registrar apenas a visita e o motivo da perda.",
          "Um produto escrito livremente fica somente no relatório de não vendas: ele não cria automaticamente um produto, SKU ou saldo no estoque.",
          "Escolha o motivo mais próximo da situação, como **produto sem estoque**, **produto que a loja não trabalha**, **preço**, **forma de pagamento**, **cliente pesquisando** ou **demora no atendimento**. Use a observação para registrar detalhes úteis.",
          "A opção **Também colocar na lista de espera** só fica disponível quando foram selecionados um cliente e um produto já cadastrados. Assim, a lista de espera continua sendo usada para avisar uma pessoa sobre um item conhecido, enquanto o registro de não venda mede toda oportunidade perdida.",
          "Na aba **Relatório**, filtre o período e o motivo. Os cartões mostram visitas sem compra, atendimentos identificados, produtos distintos, quantidade procurada e valor estimado perdido.",
          "A demanda aparece agrupada por **Fornecedor → Marca → Produto/SKU**, com atendimentos, quantidade e valor estimado separados por item. Produtos livres aparecem mesmo sem fornecedor, marca ou SKU cadastrados.",
          "Em **Atendimento × produto**, confira quem entrou, telefone, motivo, produtos e observações. Clique em **Baixar CSV** para exportar os totalizadores e os detalhes.",
          "**Conferência:** compare os motivos mais frequentes com os produtos mais procurados antes de decidir compras, mudanças de preço, formas de pagamento ou melhorias no atendimento.",
        ],
      },
      {
        slug: "central-demanda-nao-atendida",
        titulo: "Como acompanhar produtos procurados e pessoas aguardando",
        tags: [
        ...
        conteudo: [
          "**Objetivo:** reunir em uma única tela os produtos procurados no PDV, a lista de espera da loja e o **Avise-me** do e-commerce.",
          "Acesse **Produtos / Estoque → Demanda não atendida**. Os primeiros cartões separam inscrições ativas, procuras no PDV, pessoas identificadas, produtos ou termos procurados e valor estimado da oportunidade.",
          "Use o período para analisar somente as procuras registradas no PDV. As listas de espera do PDV e do e-commerce mostram sempre todas as inscrições que continuam ativas, mesmo quando foram criadas antes do período selecionado.",
          "O filtro **Ainda não cadastrado** mostra nomes escritos livremente no PDV. Use **Cadastrar** para abrir um novo produto. O sistema não cria o cadastro automaticamente, evitando duplicidades e dados incompletos.",
          "O filtro **Ausente do e-commerce** reúne produtos livres e produtos cadastrados que não estão visíveis no canal. Para os cadastrados, a situação informa se estão bloqueados, esgotados ou com dados a melhorar.",
          "Na coluna **Pessoas aguardando**, os números do PDV e do e-commerce ficam separados. O total representa inscrições por canal; uma mesma pessoa inscrita nos dois canais pode aparecer nas duas contagens.",
          "Clique em **Baixar CSV** para exportar os resultados filtrados ou em **Abrir Saúde do Catálogo** para corrigir preço, publicação e informações faltantes.",
          "**Conferência:** priorize primeiro os itens com mais pessoas aguardando e procuras recorrentes, depois confirme estoque, fornecedor e situação no e-commerce antes de comprar ou cadastrar.",
        ],
      },
      {
