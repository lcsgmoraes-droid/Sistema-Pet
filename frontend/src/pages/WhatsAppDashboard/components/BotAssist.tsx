  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b border-gray-200">
        ...
        <p className="text-xs text-gray-500 mt-1">Análise de sentimento e sugestões</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        {/* Sentiment Analyzer */}
        <div>
          <h4 className="text-sm font-semibold text-gray-700 mb-2">Analisar Sentimento</h4>
          <textarea
            value={testText}
          ...
          {sentimentResult && (
            <div className="mt-3 p-3 bg-gray-50 rounded-lg space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-gray-900">{sentimentResult.label}</span>
              </div>
        ...
        {/* Suggested Responses */}
        <div>
          <h4 className="text-sm font-semibold text-gray-700 mb-2">Respostas Sugeridas</h4>
        ...
        {/* Quick Actions */}
        <div>
          <h4 className="text-sm font-semibold text-gray-700 mb-2">Ações Rápidas</h4>
          <div className="space-y-2">
