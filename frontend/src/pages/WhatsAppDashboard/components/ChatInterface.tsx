      ...
      <div className={`border-b-4 ${priorityColors[handoff.priority]} p-4`}>
        ...
        <div className="mt-3 pt-3 border-t border-gray-200">
          ...
          {handoff.reason_details && (
            <p className="text-sm text-gray-600 mt-1">{handoff.reason_details}</p>
          )}
        </div>
      </div>
              ...
              return (
                ...
                >
                  <div className={`max-w-[70%] ${isAgent ? "order-2" : "order-1"}`}>
                    ...
                    <p
                      className={`text-xs text-gray-500 mt-1 ${isAgent ? "text-right" : "text-left"}`}
                    >
      ...
      {isResolving && (
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Resolver Conversa</h3>
