...
export const ConversationQueue: React.FC<ConversationQueueProps> = memo(
  ({ handoffs, activeHandoff, isLoading }) => {
      ...
      <div className="p-4 space-y-3">
        ...
        {visibleHandoffs.map((handoff) => {
          ...
          return (
            ...
            >
              ...
              `}
                >
                  {handoff.customer_name ? handoff.customer_name.charAt(0).toUpperCase() : "👤"}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Phone */}
                  <p className="text-xs text-gray-600 mb-2">{handoff.phone_number}</p>
                  ...
                  `}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-500">{statusIcons[handoff.status]}</span>
        ...
        {handoffs.length > visibleHandoffs.length && (
          <div className="text-xs text-gray-500 text-center py-2">
            Mostrando {visibleHandoffs.length} de {handoffs.length} conversas para manter a tela
            leve.
          </div>
        )}
      </div>
