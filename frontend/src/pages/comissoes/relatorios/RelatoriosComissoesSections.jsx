import RelatoriosComissoesDreSection from "./RelatoriosComissoesDreSection";
import {
  Bar,
  BarChart,
  CartesianGrid,
...
export default function RelatoriosComissoesSections({
  CORES,
  abaAtiva,
  dadosDRE,
  dadosMargemProduto,
  dadosProdutosPrejudiciais,
  dadosRankingCategorias,
  dadosRankingFuncionarios,
  dadosRankingProdutos,
  formatarMoeda,
  formatarPercentual,
  obterCorAlerta,
}) {
