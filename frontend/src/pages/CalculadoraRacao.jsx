...
export default function CalculadoraRacao() {
    ...
    const carregarProdutos = async () => {
        try {
            ...
            console.log('📦 Estrutura da resposta:', Array.isArray(data) ? 'Array direto' : `Objeto com keys: ${Object.keys(data).join(', ')}`);
            ...
            if (racoes.length > 0) {
                console.log('🥫 IDs das rações:', racoes.map(r => `${r.id}-${r.nome}`));
            } else {
                console.log('⚠️ Produtos sem peso_embalagem:', listaProdutos.slice(0, 5).map(p => ({
                    id: p.id,
                    nome: p.nome,
            ...
            if (racoes.length === 0 && listaProdutos.length > 0) {
                console.warn('⚠️ Produtos encontrados, mas nenhum tem peso de embalagem configurado');
                toast.error(
                ...
                <div className="form-card">
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            placeholder={form.categoria_racao === 'filhote' ? 'Obrigatório para filhotes!' : 'Ex: 24 (opcional)'}
