...
export default function BanhoTosaTaxiDogForm({
  ...
  return (
    <Panel
      ...
      subtitle="Vincule o taxi dog a um agendamento do dia e informe janela, motorista e valores."
    >
      <form onSubmit={onSubmit}>
        <div className="grid gap-3 lg:grid-cols-3">
          ...
          <SelectField
            ...
            onChange={(value) => onChangeField("agendamento_id", value)}
          >
          ...
          <SelectField
            ...
            onChange={(value) => onChangeField("motorista_id", value)}
          >
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <TextField
            ...
            onChange={(value) => onChangeField("janela_inicio", value)}
          />
          <TextField
            label="Janela fim"
            type="datetime-local"
            value={form.janela_fim}
            onChange={(value) => onChangeField("janela_fim", value)}
          />
          <TextField
            label="Km estimado"
            type="number"
            value={form.km_estimado}
            onChange={(value) => onChangeField("km_estimado", value)}
          />
          <TextField
            label="Valor cobrado"
            type="number"
            value={form.valor_cobrado}
            onChange={(value) => onChangeField("valor_cobrado", value)}
          />
        </div>
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          <TextField
            ...
            onChange={(value) => onChangeField("custo_estimado", value)}
          />
          <TextField
            label="Custo real"
            type="number"
            value={form.custo_real}
            onChange={(value) => onChangeField("custo_real", value)}
          />
          <TextField
            label="Origem"
            value={form.endereco_origem}
            onChange={(value) => onChangeField("endereco_origem", value)}
          />
          <TextField
            label="Destino"
            value={form.endereco_destino}
            onChange={(value) => onChangeField("endereco_destino", value)}
          />
        </div>
