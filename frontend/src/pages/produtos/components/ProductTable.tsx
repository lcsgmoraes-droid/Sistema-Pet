...
export const ProductTableComponent: React.FC<ProductTableProps> = ({
  ...
  const getProductTypeBadge = (tipo: string) => {
    ...
    return <span className={`product-type-badge ${badge.className}`}>{badge.label}</span>;
  };
            ...
            <tr key={product.id}>
              <td className="product-name-cell">
                <div className="product-name-wrapper">
                  ...
                  {product.marca && <span className="product-brand">{product.marca}</span>}
                </div>
              </td>
              ...
              <td className="text-right price-cell">{formatPrice(product.preco)}</td>
