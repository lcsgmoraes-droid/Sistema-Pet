    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <Panel
          ...
          actions={
            <ActionButton onClick={limparFiltros} intent="neutral" tone="ghost" size="sm">
              Limpar filtros
            </ActionButton>
          }
        >
                                ...
                                {transacao.tipo === "venda" && vendaId ? (
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-white rounded-lg p-4 border border-gray-200">
                                        ...
                                        <div>
                                          ...
                                          <p className="text-xl font-bold text-orange-600">
                                            R${" "}
                                            {(detalhes.desconto || 0).toFixed(2).replace(".", ",")}
                                          </p>
                                        </div>
                                      </div>
                                              ...
                                              <tfoot className="bg-gray-50">
                                                <tr>
                                                  ...
                                                  <td className="px-4 py-3 text-right text-lg font-bold text-green-600">
                                                    R${" "}
                                                    {detalhes.total?.toFixed(2).replace(".", ",")}
                                                  </td>
                                                </tr>
                                              </tfoot>
                                            </table>
                                  ...
                                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 text-sm">
                                      {Object.entries(transacao.detalhes || {}).map(
                                        ([key, value]) => (
                                          <div
                                            key={key}
                ...
                <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-600">
                      ...
                      de {paginacao.total_itens} transações
                    </div>
