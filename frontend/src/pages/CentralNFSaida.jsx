...
function CampoDetalhe({ label, value, mono = false, destaque = false }) {
  return (
    <div>
      ...
      <p
        className={`mt-1 ${mono ? "font-mono text-xs break-all" : "text-sm"} ${destaque ? "text-lg font-bold text-gray-900" : "text-gray-900"}`}
      >
...
export default function CentralNFSaida() {
  ...
  async function abrirDetalhes(nota) {
    ...
    try {
      ...
      setErroDetalhe(
        error.response?.data?.detail || "Nao foi possivel carregar todos os detalhes desta nota.",
      );
    } finally {
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <label className="flex items-center gap-2 text-sm text-gray-700">
                      <input
                        ...
                        onChange={(e) =>
                          setCfg((p) => ({ ...p, importacao_automatica: e.target.checked }))
                        }
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setCfg((p) => ({
                            ...p,
                            importacao_intervalo_min: Number(e.target.value || 15),
                          }))
                        }
                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-1 text-xs text-gray-500 flex gap-4">
                      <span>
                        Chave: <span className="font-mono">{d.chave_acesso}</span>
                      </span>
                      <span>
                        Total:{" "}
                        <strong className="text-gray-800">
                          {formatMoneyBRL(d.valor_total_nf)}
                        </strong>
                      </span>
            ...
            <div className="p-6 space-y-4">
              ...
              <SecaoDetalhe titulo="Dados fiscais">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <CampoDetalhe
                    label="Data saida"
                    value={formatarDataBR(detalheNota?.data_saida)}
                  />
                  ...
                  <CampoDetalhe
                    label="Indicador presenca"
                    value={detalheNota?.indicador_presenca}
                  />
                </div>
              </SecaoDetalhe>
              ...
              <SecaoDetalhe titulo="Loja e canal">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <CampoDetalhe
                    ...
                    value={detalheNota?.unidade_negocio?.nome}
                  />
                  <CampoDetalhe
                    label="Canal venda"
                    value={
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
                ...
                <SecaoDetalhe titulo="Entrega e transporte">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <CampoDetalhe
                      label="Nome entrega"
                      value={detalheNota?.endereco_entrega?.nome}
                    />
                ...
                <SecaoDetalhe titulo="Pagamento">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <CampoDetalhe
                      ...
                      value={detalheNota?.pagamento?.condicao}
                    />
              ...
              <SecaoDetalhe titulo="Informacoes adicionais">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    <CampoDetalhe
                      label="Informacoes de interesse do fisco"
