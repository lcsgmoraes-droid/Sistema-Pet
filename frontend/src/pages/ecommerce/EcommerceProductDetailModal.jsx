    ...
    >
      ...
      >
        <div
          style={{
            background: "#f5f5f4",
            borderRadius: isMobile ? 0 : "18px 0 0 18px",
            padding: 24,
            display: "flex",
            ...
            <div style={{ display: "flex", gap: 8, overflowX: "auto" }}>
              {images.map((image) => (
                <button
                  ...
                  style={{
                    border: activeImage === image ? "2.5px solid #f97316" : "1.5px solid #e7e5e4",
                    borderRadius: 10,
                    width: 70,
                    height: 70,
                    overflow: "hidden",
        ...
        <div style={{ padding: 28, display: "grid", alignContent: "start", gap: 14 }}>
          ...
          >
            ...
            <div style={{ fontSize: 13, color: "#6b7280" }}>
              SKU:{" "}
              <strong style={{ color: "#1a1a2e", fontFamily: "monospace" }}>
                {product?.codigo || "-"}
              </strong>
            </div>
            <div
              style={{
                fontSize: 13,
                color: outOfStock ? "#b45309" : "#065f46",
                display: "inline-flex",
                alignItems: "center",
                gap: 5,
              }}
