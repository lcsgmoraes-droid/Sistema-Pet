    ...
    <div style={{ padding: "24px 32px", maxWidth: 1200, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 28 }}>
        ...
        <div>
          <h1 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: "#1f2937" }}>
            Analytics do E-commerce
          </h1>
          <p style={{ margin: 0, fontSize: 14, color: "#6b7280" }}>
            Visão geral de pedidos, demanda e produtos
          </p>
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 32 }}>
        ...
        <StatCard
          ...
          sub={`Ticket médio: ${formatCurrency(resumo?.ticket_medio)}`}
          color="#10b981"
        />
        <StatCard
          icon="🛒"
          ...
          sub="Há mais de 1h sem finalizar"
          color="#f59e0b"
        />
        <StatCard
          icon="🔔"
          label="Avise-me pendentes"
          value={resumo?.avise_me_pendentes ?? 0}
          sub="Clientes aguardando reposição"
          color="#ef4444"
        />
      </div>
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: "#9ca3af" }}>
                Produtos com "Avise-me" pendentes — precisa repor
              </div>
            </div>
          </div>
          {demanda.length === 0 ? (
            <div style={{ padding: 24, color: "#9ca3af", textAlign: "center" }}>
              Nenhum pedido de aviso pendente 🎉
            </div>
          ) : (
                ...
                {demanda.map((d, i) => (
                  ...
                  >
                    ...
                    <td style={{ ...td, fontWeight: 500 }}>
                      {d.product_name || `Produto #${d.product_id}`}
                    </td>
                    ...
                    <td
                      style={{
                        ...td,
                        textAlign: "center",
                        color: d.estoque_atual <= 0 ? "#ef4444" : "#10b981",
                        fontWeight: 600,
                      }}
                    >
                      {d.estoque_atual}
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: "#9ca3af" }}>
                Produtos com maior volume de vendas no e-commerce
              </div>
            </div>
          </div>
            ...
            <tbody>
              {pedidosRecentes.map((p, i) => (
                <tr key={`pr-${p.pedido_id ?? i}`} style={{ borderBottom: "1px solid #f3f4f6" }}>
                  ...
                  <td style={{ ...td, textAlign: "right", fontWeight: 600, color: "#1f2937" }}>
