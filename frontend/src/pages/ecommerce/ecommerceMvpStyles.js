const ecommerceMvpStyles = {
  ...
  sidebar: { background: '#fff', borderRadius: 16, border: '1px solid #e7e5e4', padding: 20, alignSelf: 'start', position: 'sticky', top: 80, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', boxSizing: 'border-box', minWidth: 0, maxWidth: '100%', overflow: 'hidden' },
  ...
  miniItem: { display: 'flex', gap: 8, alignItems: 'center', borderBottom: '1px solid #f5f5f4', paddingBottom: 8, marginBottom: 4, width: '100%', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box', overflow: 'hidden' },
  ...
  subtotalBox: { background: '#fff7ed', borderRadius: 10, padding: '10px 12px', marginTop: 6, display: 'flex', justifyContent: 'space-between', alignItems: 'center', border: '1px solid #fed7aa', width: '100%', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box', gap: 10 },
  checkoutBig: { background: 'linear-gradient(135deg,#f97316,#fb923c)', border: 'none', color: '#fff', borderRadius: 10, padding: '12px 0', fontWeight: 700, fontSize: 14, cursor: 'pointer', width: '100%', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box', marginTop: 8, boxShadow: '0 4px 14px rgba(249,115,22,0.35)' },
  viewCartBtn: { background: 'transparent', border: '2px solid #f97316', color: '#f97316', borderRadius: 10, padding: '10px 0', fontWeight: 700, fontSize: 13, cursor: 'pointer', width: '100%', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box', marginTop: 6 },
  cartItem: { border: '1px solid #e7e5e4', borderRadius: 14, padding: '14px', display: 'flex', gap: 14, alignItems: 'center', background: '#fff', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', minWidth: 0, boxSizing: 'border-box' },
