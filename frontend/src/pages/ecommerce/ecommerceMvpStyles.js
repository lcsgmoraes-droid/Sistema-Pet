export const ecommerceMvpStyles = {
  ...
  statusBadge: (status) => {
    ...
    const current = map[String(status).toLowerCase()] || { bg: '#f5f5f4', color: '#555' };
    return { background: current.bg, color: current.color, borderRadius: 20, padding: '3px 10px', fontSize: 11, fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: 4 };
  },
