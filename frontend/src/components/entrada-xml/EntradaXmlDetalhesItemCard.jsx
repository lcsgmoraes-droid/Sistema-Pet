      ...
      <div className="grid grid-cols-[1fr_auto_1fr] gap-0">
        ...
        <div className="bg-blue-50 border-r-2 border-gray-300 p-4">
          ...
          <div className="space-y-1.5 text-sm">
            ...
            {item.ean_tributario &&
              item.ean_tributario !== item.ean &&
              item.ean_tributario !== "SEM GTIN" && (
                <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-amber-700">
                R$ {formatarValorFiscal(obterCustoAquisicaoItem(itemAjustado), 4)}
              </span>
            </div>
            <div className="flex justify-between">
              ...
              {temDivergencia && (
                <div className="bg-red-100 border-2 border-red-500 rounded-lg p-2 max-w-[200px]">
                  <div className="text-center">
                    ...
                    <div className="font-bold text-red-700 text-xs mb-1">DIVERGÊNCIA!</div>
        ...
        {notaSelecionada.status === "pendente" && tipoRateio === "parcial" && item.produto_id && (
          <div className="col-span-3 p-4 border-t-2 border-gray-300 bg-gradient-to-r from-blue-50 via-gray-50 to-green-50">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  value={(
                    item.quantidade - (quantidadesOnline[item.id] ?? item.quantidade_online ?? 0)
                  ).toFixed(2)}
                  disabled
                  className="w-full px-3 py-2 border border-gray-300 rounded bg-gray-100 text-base font-semibold"
                />
            ...
            <div className="mt-3 text-sm text-gray-700 bg-white rounded-lg p-3 border border-gray-300 font-medium">
              Valor online: R${" "}
              {(
                (quantidadesOnline[item.id] ?? item.quantidade_online ?? 0) * item.valor_unitario
              ).toFixed(2)}
            </div>
            ...
            quantidadesOnline[item.id] !== item.quantidade_online ? (
              ...
              item.quantidade_online !== null &&
              item.quantidade_online !== undefined && (
                <div className="mt-3 text-sm text-green-700 bg-green-50 rounded-lg p-3 border border-green-200 flex items-center justify-center font-medium">
                  Salvo: {item.quantidade_online} online /{" "}
                  {(item.quantidade - item.quantidade_online).toFixed(2)} loja
                </div>
              )
            )}
          </div>
        ...
        {mostrarTratativaItem && (
          <div className="border-t border-emerald-200 bg-emerald-50/60 p-4">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
              ...
              >
                {conferenciaItem.temDivergencia
                  ? `Divergencia: ${conferenciaItem.statusConferencia}`
                  : "OK"}
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  value={
                    conferenciaItens[item.id]?.quantidade_conferida ??
                    conferenciaItem.quantidadeConferida
                  }
                  onChange={(e) =>
              ...
              <div>
                ...
                <input
                  ...
                  max={Math.max(
                    0,
                    conferenciaItem.quantidadeNF - conferenciaItem.quantidadeConferida,
                  )}
                  step="0.01"
                  disabled={!podeEditarQuantidadesItem}
                  value={
                    conferenciaItens[item.id]?.quantidade_avariada ??
                    conferenciaItem.quantidadeAvariada
                  }
                  onChange={(e) =>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-3 mt-3">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={
                    conferenciaItens[item.id]?.observacao_conferencia ??
                    conferenciaItem.observacaoConferencia
                  }
                  onChange={(e) =>
