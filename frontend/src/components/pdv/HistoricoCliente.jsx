...
export default function HistoricoCliente({ cliente, clienteId, clienteNome, onClose }) {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <span
        className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${badges[status] || "bg-gray-100 text-gray-800"}`}
      >
      ...
      <div className="bg-white rounded-lg max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                title={
                  mostrarResumoGerencial ? "Ocultar resumo gerencial" : "Mostrar resumo gerencial"
                }
              >
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    {valorResumo(historico.total_compras)}
                  </div>
                </div>
              </div>
            </div>
          ...
          {historico.ultima_compra && (
            <div className="mt-4 bg-white rounded-lg p-3 shadow-sm flex items-center space-x-2 text-sm">
              ...
              <span className="text-gray-600">
                Última compra:{" "}
                {new Date(historico.ultima_compra).toLocaleDateString("pt-BR", {
                  day: "2-digit",
                  month: "long",
                  year: "numeric",
                })}
                                ...
                                {venda.desconto_valor > 0 && (
                                  <div>
                                    ...
                                    <div className="font-medium text-red-600">
                                      - {formatBRL(venda.desconto_valor)}
                                    </div>
                                  </div>
                                )}
                                  ...
                                  <table className="w-full text-sm">
                                    ...
                                    <tbody>
                                      {itensDaVenda.map((item, index) => {
                                        ...
                                        return (
                                          <tr
                                            key={`${item.nome}-${item.quantidade}-${item.preco_unitario}-${item.subtotal}-${index}`}
                                                    ...
                                                    <button
                                                      ...
                                                      onClick={() =>
                                                        copiarCampoItem(
                                                          nomeItem,
                                                          chaveNome,
                                                          "Nao foi possivel copiar o nome do item",
                                                        )
                                                      }
                                                    ...
                                                    <button
                                                      ...
                                                      onClick={() =>
                                                        copiarCampoItem(
                                                          itemSku,
                                                          chaveSku,
                                                          "Nao foi possivel copiar o codigo do item",
                                                        )
                                                      }
                                                      className="text-gray-400 hover:text-gray-700 transition-colors"
                                                      title="Copiar SKU"
                            ...
                            {!carregandoVenda &&
                              ...
                              pagamentosDaVenda.length === 0 && (
                                <div className="text-sm text-gray-500">
                                  Nao ha detalhes para esta venda.
                                </div>
                              )}
                          </div>
                        )}
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          <div className="flex justify-between items-center text-sm text-gray-600">
            <span>
              Mostrando {vendasFiltradas.length} de {historico.vendas?.length || 0} vendas
            </span>
            <button
              onClick={onClose}
