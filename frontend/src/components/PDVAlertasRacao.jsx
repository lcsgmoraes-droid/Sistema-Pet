 ...
 */
const PDVAlertasRacao = ({ produtoId, clienteId, carrinho = [], onAddProduto, onClose }) => {
  // ============================================================================
  // STATES
  // ============================================================================
        ...
        <div className="bg-red-50 border-2 border-red-300 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-red-800 font-bold text-lg mb-2">{alerta.mensagem}</p>
              ...
              <div key={idx} className="bg-white border border-red-200 rounded-lg p-3">
                ...
                <div className="text-sm text-gray-700">
                  ...
                  {pet.alergias.map((a, i) => (
                    <span
                      key={i}
                      className="inline-block bg-red-100 text-red-800 px-2 py-0.5 rounded mr-1 mb-1"
                    >
                      {a}
                    </span>
                  ))}
          ...
          >
            ...
            <div className="flex items-center justify-between mt-3">
              <div>
                ...
                {produto.preco_kg && (
                  <p className="text-xs text-gray-500">R$ {produto.preco_kg.toFixed(2)}/kg</p>
                )}
              </div>
