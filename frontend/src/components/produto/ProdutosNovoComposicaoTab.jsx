    ...
    <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  O estoque e calculado <strong>automaticamente</strong> com base nos componentes
                  disponiveis.
                </p>
            ...
            {!formData.e_kit_fisico && (
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded text-sm text-blue-800">
                ...
                <span className="text-xs italic">
                  Estoque do kit = menor disponibilidade entre os componentes (considerando as
                  quantidades necessarias)
                </span>
              </div>
            )}
            {formData.e_kit_fisico && (
              <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded text-sm text-green-800">
                ...
                <br />
                <strong>Entrada no kit:</strong> Os componentes serao automaticamente DIMINUIDOS
                (unitarios viraram kit).
                <br />
                <strong>Saida manual:</strong> Voce podera escolher se os componentes voltam ao
                estoque (desfez o kit) ou nao (perda/roubo).
              </div>
            )}
          </div>
        </div>
                  ...
                  return filtrados.length > 0 ? (
                    <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-64 overflow-y-auto">
                      {filtrados.map((produto) => (
                        ...
                        >
                          <span>
                            <span className="font-semibold text-blue-700">{produto.codigo}</span> –{" "}
                            {produto.nome}
                          </span>
      ...
      <div>
        <h4 className="font-semibold text-gray-900 mb-3">
          Produtos no Kit ({formData.composicao_kit.length})
        </h4>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {formData.composicao_kit.map((item) => {
                  ...
                  return (
                    <tr
                      key={item.produto_id}
                      className={`hover:bg-gray-50 ${eGargalo ? "bg-yellow-50" : ""}`}
                    >
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-red-800">
              ...
              <p className="mt-1">
                Pelo menos um dos componentes esta sem estoque suficiente para montar o kit.
              </p>
            </div>
          </div>
        </div>
