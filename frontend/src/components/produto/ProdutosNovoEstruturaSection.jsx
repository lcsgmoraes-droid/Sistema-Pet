          ...
          <div className="p-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-200">
            ...
            {mostrarBuscaPredecessor ? (
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div className="font-semibold text-gray-900 mt-1">
                            {predecessorSelecionado.nome}
                          </div>
                          <div className="text-sm text-gray-600">
                            SKU: {predecessorSelecionado.codigo}
                          </div>
                        </div>
                        <button
                          type="button"
                  ...
                  <div className="p-4 bg-white rounded-lg border-2 border-amber-300">
                    ...
                    <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded text-sm text-blue-800">
                      ...
                      <ul className="mt-2 space-y-1 list-disc list-inside">
                        <li>
                          O produto "<strong>{predecessorSelecionado.nome}</strong>" sera marcado
                          como <strong>descontinuado</strong>
                        </li>
              ...
              <p className="text-sm text-gray-600 mt-2">
                Marque esta opcao se este produto substitui outro ja cadastrado (ex: mudanca de
                embalagem de 350g para 300g). Isso permite manter o historico consolidado de vendas.
              </p>
            )}
          </div>
        </div>
        ...
        <div className="border-t pt-6">
          <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Escolha ou ajuste a estrutura deste produto:
            </p>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex-1">
                  <label
                    htmlFor="tipo_simples"
                    className="font-medium text-gray-900 cursor-pointer"
                  >
                    Produto Simples
                  </label>
                  <p className="text-sm text-gray-600 mt-1">
                    Produto unico, vendavel, com controle de estoque proprio.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1">
                  <label
                    htmlFor="tipo_variacoes"
                    className="font-medium text-gray-900 cursor-pointer"
                  >
                    Produto com Variacoes
                  </label>
                  <p className="text-sm text-gray-600 mt-1">
                    Produto agrupador (nao vendavel). Tera variacoes com SKU, preco e estoque
                    proprios.
                    <br />
                    <span className="text-xs italic">
                      Exemplo: Camiseta (produto pai) {"->"} P, M, G (variacoes)
                    </span>
                  </p>
                  {formData.tipo_produto === "PAI" && !isEdicao && (
                    <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded text-sm text-yellow-800">
                      <strong>Salve o produto primeiro</strong> para depois cadastrar as variacoes
                      na aba "Variacoes".
                    </div>
                  )}
                  {formData.tipo_produto === "PAI" && isEdicao && (
                    <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded text-sm text-green-800">
                      A aba "Variacoes" esta disponivel. Se voce acabou de mudar a estrutura, clique
                      em Atualizar antes de cadastrar novas variacoes.
                    </div>
                  )}
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1">
                  <label htmlFor="tipo_kit" className="font-medium text-gray-900 cursor-pointer">
                    Produto com Composicao (Kit)
                  </label>
                  <p className="text-sm text-gray-600 mt-1">
                    Kit composto por outros produtos existentes.
                    <br />
                    <span className="text-xs italic">
                      Exemplo: Kit Banho (shampoo + condicionador + toalha)
                    </span>
                  </p>
                  {formData.tipo_produto === "KIT" && (
                    <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded text-sm text-green-800">
                      <strong>Aba "Composicao" aberta!</strong> Va para a aba Composicao para
                      definir se o kit tera estoque virtual ou fisico e adicionar os produtos que o
                      compoem.
                    </div>
                  )}
                </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-white rounded-lg border-2 border-gray-300">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  ...
                  <br />
                  <span className="text-xs italic">
                    Exemplo: Camiseta P - Kit (camiseta + brinde)
                  </span>
                </p>
                {formData.tipo_kit && (
                  <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded text-sm text-green-800">
                    <strong>Variacao configurada como KIT!</strong> Va para a aba "Composicao" para
                    definir os produtos que compoem este kit.
                  </div>
                )}
              </div>
            </div>
