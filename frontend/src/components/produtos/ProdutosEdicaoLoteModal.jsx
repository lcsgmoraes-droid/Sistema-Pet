    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-xl">
        ...
        <div className="space-y-6 overflow-y-auto px-6 py-5">
          ...
          <ProdutosFornecedoresLoteSection
      ...
      <FornecedorPrincipalDecisaoModal
        decisaoFornecedor={decisaoFornecedor}
        isOpen={mostrarDecisaoFornecedor}
        nomeFornecedor={nomeFornecedorSelecionado}
        onClose={fecharDecisaoFornecedor}
        onConfirm={confirmarDecisaoFornecedor}
        onSelectDecisao={setDecisaoFornecedor}
