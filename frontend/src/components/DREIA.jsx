...
export default function DREIA() {
  ...
  // Filtros
  const [usuarioId] = useState(1); // Ajustar conforme auth
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <CardDRE
          ...
          icon={<TrendingDown />}
        />
        <CardDRE titulo="Lucro Bruto" valor={dados.lucro_bruto} cor="green" icon={<TrendingUp />} />
        <CardDRE
          titulo="Margem Bruta"
                ...
                <td className="px-4 py-3 text-right">
                  {modoAlocacao === "proporcional" ? (
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onAlocacaoChange(idx, "valor_alocado", parseFloat(e.target.value))
                      }
...
function TrDRE({ label, valor, destaque, color }) {
  return (
    <tr className={destaque ? "bg-gray-100 font-semibold" : ""}>
      ...
      <td
        className={`px-6 py-3 text-right ${color === "green" ? "text-green-600 font-bold" : "text-gray-900"}`}
      >
        R$ {valor?.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
      </td>
    </tr>
    ...
    <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-600">
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-semibold">
            R$ {canal.custo?.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-600">Despesas:</span>
          <span className="font-semibold">
            R$ {canal.despesas?.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
          </span>
        </div>
