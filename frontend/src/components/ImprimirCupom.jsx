...
const vendaPropType = PropTypes.shape({
  ...
  total_pago: PropTypes.number,
  valor_pago: PropTypes.number,
  valor_restante: PropTypes.number,
  ...
  pagamentos: PropTypes.arrayOf(
    PropTypes.shape({
      ...
      valor_recebido: PropTypes.number,
      troco: PropTypes.number,
      modalidade_cartao: PropTypes.string,
