...
const InputTextoLongo = forwardRef(function InputTextoLongo(
  ...
  return (
    <label
      className={["block w-full", preencherAltura ? "flex h-full flex-col" : ""]
        .filter(Boolean)
        .join(" ")}
    >
      {label ? (
      ...
      <textarea
        ...
        className={[
          "mt-1 w-full rounded-lg border bg-white px-3 py-2 text-sm text-slate-900 outline-none transition-colors",
          preencherAltura ? "flex-1 resize-none" : "resize-y",
