...
const ExtratoBancario = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      alert(
        `Upload concluído! ${response.data.categorias_aplicadas} categorias aplicadas automaticamente.`,
      );
    } catch (error) {
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div className="space-y-1 text-sm">
                  <p>
                    ...
                    <span className="font-bold">{resultado.total_lancamentos}</span>
                  </p>
                  <p>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Data: {new Date(lancamento.data).toLocaleDateString("pt-BR")} | Valor: R${" "}
