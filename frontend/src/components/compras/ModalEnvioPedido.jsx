        ...
        <div className="space-y-4">
          {pedidoSemFornecedor ? (
            <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
              Este pedido foi criado sem fornecedor. Baixe o PDF pelo menu <strong>Mais</strong>,
              envie pelo canal que preferir e depois marque o envio manual abaixo.
            </div>
          ) : null}
          ...
          {!pedidoSemFornecedor ? (
            <div>
              ...
              >
                <span className="font-semibold">Mais de um destinatário?</span> Separe os e-mails
                com ponto e vírgula (;) ou vírgula (,).
          ...
          {!pedidoSemFornecedor && emailEnvioDisponivel === false && (
