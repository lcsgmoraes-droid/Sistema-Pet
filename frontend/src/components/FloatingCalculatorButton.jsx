...
export default function FloatingCalculatorButton({ onClick }) {
  ...
  const handleToggleMinimize = (e) => {
    ...
    if (!newVal) {
      // se vai expandir (newVal = false = expandido)
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 pointer-events-none">
              ...
              <span className="text-xs font-semibold text-gray-700">Calculadora</span>
            </div>
          ...
          {!isMobile && (
            <div className="text-[10px] text-gray-500 text-center">Arraste para mover</div>
          )}
        </div>
      )}
    </div>
