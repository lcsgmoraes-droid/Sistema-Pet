...
const DashboardRacoesComparacaoDetalhada = ({
  ...
  ordenacao,
    ...
    const margens = produtosComparacao.map((produto) => calcularMargem(produto.preco_custo, produto.preco_venda));
    const lucros = produtosComparacao.map((produto) => calcularLucro(produto.preco_custo || 0, produto.preco_venda || 0));
    const rois = produtosComparacao.map((produto) => calcularROI(produto.preco_custo, produto.preco_venda));
