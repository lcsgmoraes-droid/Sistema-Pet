      ...
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4 border-2 border-gray-300">
          <p className="text-sm font-bold text-gray-800 mb-3 flex items-center gap-2">
            <span className="text-lg">📖</span> Legenda e Dicas de Interpretação:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-2 text-xs">
                <span className="font-bold text-red-700">🔴 Vermelho:</span>
                <span className="text-gray-700">Valores piores (maior custo, menor margem/lucro)</span>
              </div>
              <div className="flex items-start gap-2 text-xs">
                <span className="font-bold text-yellow-700">🟡 Amarelo:</span>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Análise Inteligente de Rações
          </h1>
          <p className="text-sm text-gray-600 mt-1">
            Dashboard dinâmico com análises avançadas de margem e vendas
          </p>
        </div>
