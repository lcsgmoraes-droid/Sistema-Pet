...
const AnaliseVendaDrawer = ({ mostrar, onFechar, dados, carregando }) => {
  ...
  return (
    <>
      {/* Overlay escuro */}
      <div className="fixed inset-0 bg-black bg-opacity-50 z-40" onClick={onFechar} />
            ...
            <>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {formatarMoeda(dados.composicao.total_produtos)}
                    </span>
                  </div>
                    ...
                    <div className="flex justify-between text-red-600">
                      ...
                      <span className="font-semibold">
                        ...
                        <span className="text-xs ml-1">
                          (
                          {(
                            (dados.composicao.desconto / dados.composicao.total_produtos) *
                            100
                          ).toFixed(1)}
                          %)
                        </span>
                  ...
                  {dados.composicao.taxa_entrega > 0 && (
                    <div className="flex justify-between text-red-600">
                      ...
                      <span className="font-semibold">
                        {formatarMoeda(dados.composicao.taxa_entrega)}
                      </span>
                    </div>
                  )}
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="space-y-2 text-sm">
                      ...
                      {dados.detalhamento_taxas.map((taxa, idx) => (
                        <React.Fragment key={idx}>
                          ...
                          {taxa.taxa_fixa > 0 && (
                            <div className="flex justify-between">
                              <div className="flex flex-col">
                                <span className="text-gray-600">Taxa Fixa {taxa.forma}</span>
                                <span className="text-xs text-gray-500">
                  ...
                  {(!dados.detalhamento_taxas || dados.detalhamento_taxas.length === 0) &&
                    dados.deducoes.taxa_percentual > 0 && (
                      <div className="flex justify-between">
                  ...
                  <div className="border-t pt-2 mt-2">
                    <div className="flex justify-between font-semibold text-gray-700">
                      ...
                      <span className="text-red-600">
                        {formatarMoeda(dados.deducoes.total_deducoes)}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {/* Resultado Final */}
              <div
                className={`rounded-lg p-4 border-2 ${getCorMargem(dados.resultado.cor_indicador)}`}
              >
                <div className="flex items-center gap-2 mb-3">
                  <FiBarChart2 className="w-5 h-5" />
