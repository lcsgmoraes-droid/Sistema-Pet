...
function EstoqueBling() {
          ...
          return (
            <PendingCard
              ...
              reason={{
                ...
                description:
                  item.motivo ||
                  "O produto ja existe dos dois lados, falta apenas criar o vinculo.",
              }}
              details={[
  ...
  const renderFixTab = () => {
    ...
    if (syncError && !filteredFix.length) {
      return (
        <EmptyState title="Nao foi possivel carregar as falhas agora" description={syncError} />
      );
    }
            ...
            {hasAnySnapshot ? (
              <>
                ...
                <div className="text-sm text-slate-500">
                  Ultima leitura:{" "}
                  {formatDate(
                    cobertura.atualizado_em ||
                      faltantesMeta.atualizadoEm ||
                      vinculosMeta.atualizadoEm,
                  )}{" "}
                  | Cache:{" "}
                  {formatCacheAge(
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {activeTab === "corrigir" ? (
              <>
                <button
                  onClick={
                    shouldShowReconnectWarning ? handleReconnectBling : handleReprocessFailures
                  }
                ...
                <button
                  onClick={() =>
                    runGlobalAction(
                      ...
                      () =>
                        api.post(
                          "/estoque/sync/reconciliar-recentes",
                          { limit: 150, minutes: 30 },
                          { timeout: 0 },
                        ),
