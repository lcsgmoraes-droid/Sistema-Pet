...
export default function ExtratoCredito({ clienteId, refreshKey = 0 }) {
  ...
  useEffect(() => {
    ...
    setErro("");
    api
      .get(`/clientes/${clienteId}/credito/extrato?limit=50`)
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
      ...
      <div className="px-5 py-4">
        ...
        {!loading && erro && <p className="text-center text-red-500 text-sm py-4">{erro}</p>}
            ...
            {visivel.map((mov) => {
              ...
              return (
                ...
                >
                  {/* Ícone */}
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 bg-white border ${cfg.borda}`}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        ...
                        {mov.motivo && (
                          <p
                            className="text-xs text-gray-600 mt-0.5 truncate max-w-[220px]"
                            title={mov.motivo}
                          >
                            {mov.motivo}
                          </p>
                      ...
                      <div className="text-right flex-shrink-0">
                        <p
                          className={`text-sm font-bold ${isPositivo ? "text-green-600" : "text-red-600"}`}
                        >
