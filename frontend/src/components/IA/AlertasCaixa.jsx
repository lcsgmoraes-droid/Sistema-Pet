...
export default function AlertasCaixa({ alertas }) {
  if (!alertas || alertas.length === 0) {
    return (
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Alertas do Caixa</h3>
  ...
  const alertasOrdenados = [...alertas].sort(
    (a, b) => (prioridade[a.tipo] || 3) - (prioridade[b.tipo] || 3),
  );

  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">Alertas do Caixa</h3>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className={`font-medium ${config.textColor} mb-1`}>{alerta.titulo}</h4>
