            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <CenarioIcon
                    className={`w-6 h-6 ${
                      isSelected ? `text-${cenario.color}-600` : "text-gray-400"
                    }`}
                  />
                  <h4
                    className={`font-semibold ${
                      isSelected ? `text-${cenario.color}-900` : "text-gray-900"
                    }`}
                  >
                    {cenario.nome}
                  </h4>
                ...
                <p
                  className={`text-sm ${
                    isSelected ? `text-${cenario.color}-700` : "text-gray-600"
                  }`}
                >
                  {cenario.descricao}
                </p>
                    ...
                    >
                      {new Intl.NumberFormat("pt-BR", {
                        ...
                        resultadoSimulacao?.projecoes_ajustadas?.[
                          resultadoSimulacao?.projecoes_ajustadas?.length - 1
                        ]?.saldo_ajustado || 0,
                      )}
                    </span>
                  </div>
